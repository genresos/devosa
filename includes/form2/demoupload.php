<?php
  ...
  $f = new clsForm("form1", /*1 column view*/1, "900","500");
  ...
  $f->addInputFile("File", "dataFile", /*masukkan nama file lama*/"", "Hint: Upload file", false, true, true, true, false, "string", null,"","","",50,20, $uploadPath);
  
  $f->addSubmit("btnUpload", "Upload","Save this change", true,true, null, "", "", "afterUpload()","onClick=\"return confirm('Do you want to upload this file?');\"");
