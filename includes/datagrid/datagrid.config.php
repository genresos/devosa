 ...
 */
  ...
  $GLOBALS['CLASSDATAGRIDPATH'] = "../includes/datagrid/";
  //default page limit
  $DEFAULTPAGELIMIT = "15";
  //default paging size
  ...
  {
    $ARRAY_PAGE_LIMIT = array ("all", "100", "50", "25", "20", "15");
    $DATAGRIDWORDS = array(
  ...
  {
    $ARRAY_PAGE_LIMIT = array ("semua", "100", "50", "25", "20", "15");
    $DATAGRIDWORDS = array(
