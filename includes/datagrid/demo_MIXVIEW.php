...
error_reporting(0);
  ...
  $f = new clsForm("form1", /*2 column view*/2, "100%","100%", "../form/");
  ...
  $myDataGrid->addColumnCheckbox(new DataGrid_Column("chkID", "id", array('rowspan' => 2, 'width' => '30'), array('align'=>'center', 'nowrap' => ''), false, false, "", "", "string", false));
  ...
  $myDataGrid->addColumn(new DataGrid_Column("Employee ID", "employeeID", array('rowspan' => 2, 'width' => '100'), array('align' => 'center', 'nowrap' => ''), true, true, "", "", "string", true, 12));

  //add spanned column 3
  $myDataGrid->addColumn(new DataGrid_Column("Employee Information", "", array('colspan' => '3')));

  //if you not remember enough, you can also modified the Datagrid_Column first,  before call addColumn, like this...
  $employeeNameField = new DataGrid_Column("Name", "employeeName", array('width' => '250'), array('nowrap' => ''));
  $employeeNameField->xlsColumnWidth = 32;
  $myDataGrid->addColumn($employeeNameField);//new DataGrid_Column("Name", "employeeName", array('width' => '250'), array('nowrap' => ''), true, true, null, null, "string", true, 32));
  
  $employeeAddress = new DataGrid_Column("Name", "primaryAddress", null, array('nowrap' => ''));
  $employeeAddress->xlsColumnWidth = 64;
  $myDataGrid->addColumn($employeeAddress);

  $myDataGrid->addColumn(new DataGrid_Column("Department", "departmentCode", array('width' => '150'), array('nowrap' => ''), true, true, "", "", "string", true, 12));
  
  $myDataGrid->addColumn(new DataGrid_Column("", "", array('rowspan' => 2, 'width' => '40'), array('align' => 'center'), false, false, "", "printEditLink()", "string", false));
