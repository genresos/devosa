<?php
  ...
  $f->addSubmit("btnSave", "Save","Save this change", true,true, null, "", "", "saveDasata()","onClick=\"return confirm('Do you want to save this entry?');\"");
  ...
  function deleteData() 
  {
    ...
    else
    {
      ...
      return executeDeleteSQL($strSQL, "Employee", /*send message to datagrid */$myDataGrid->message);
    }
    return false;        
  } //deleteData
