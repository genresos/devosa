...
class clsDate
{
  ...
  {
    $this->intTimeStamp = mktime($this->intHour, $this->intMinute, $this->intSecond, $this->intMonth, $this->intDay, $this->intYear);
    if ($isShortName)
  ...
  {
    $this->intTimeStamp = mktime($this->intHour, $this->intMinute, $this->intSecond, $this->intMonth, $this->intDay + $intDay, $this->intYear);
  ...
  {
    $this->intTimeStamp = mktime($this->intHour, $this->intMinute, $this->intSecond, $this->intMonth + $intMonth, $this->intDay, $this->intYear);
    $this->convertTimeStampToDate();
    return $this;
  }
  ...
  {
    $this->intTimeStamp = mktime($this->intHour, $this->intMinute, $this->intSecond, $this->intMonth, $this->intDay, $this->intYear + $intYear);
  ...
  {
    $this->intTimeStamp = mktime($this->intHour + $intHour, $this->intMinute, $this->intSecond, $this->intMonth, $this->intDay, $this->intYear);
  ...
  {
    $this->intTimeStamp = mktime($this->intHour, $this->intMinute + $intMinutes, $this->intSecond, $this->intMonth, $this->intDay, $this->intYear);
    $this->convertTimeStampToDateTime();
    return $this;
  }
  ...
  {
    $this->intTimeStamp = mktime($this->intHour, $this->intMinute, $this->intSecond + $intSeconds, $this->intMonth, $this->intDay, $this->intYear);
    $this->convertTimeStampToDateTime();
    return $this;
  }
