...
$dataMain = array("Home" => "javascript:alert(\"home's clicked\")", 
                  "Transaction" => array("Transaction 1" => "demo1.php", 
                                  "Transaction 2" => "demo2.php",
                                  "Transaction 3" => array("Demo4" => "demo4.php",
                                                   "Demo5" => "demo5.php")
                                        ),
                  "Report"      => array("Report1" => "report1.php", 
                                  "Report2" => "report2.php",
                                  "-" => "",
                                  "Report3" => "report3.php")
                  );
