...
class clsForm
{
  ...
  {
    $this->groupingNumber++;
    $this->fieldSet[$this->groupingNumber] = array("name" => $name);
  }
  
  function addFormObject($type, $caption, $name, $value, $default, $hint, $readonly=false, $enabled=true, $validate=true, $visible = true, $createHidden = false, $dataType = "string",$arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="", $serverAction="", $size=0, $maxlength=0, $targetFolder = "", $labelStyle = null)
  {
    if ($type=='select' || $type == 'radio')
    {
      ...
      else
      {
        foreach($value as $key => &$val)
        {
          if (!is_array($val))
          {
            $tempVal = array("id" => "", "value" => $key, "text" => $val, $selectKey => false);
            $val = $tempVal;
          }
          else
          {
            ...
            if (!isset($val[$selectKey])) $val[$selectKey] = false;
    ...
    $dataForm = array("readonly"=>$readonly, 
                      "enabled"=>$enabled, 
                      "visible" => $visible, 
                      "validate" => $validate,
                      "caption"=>$caption, 
    ...
    if ($createHidden)
      $this->formHidden[$name] = array("name"=>"hidden_".$name, "value"=> $selectedValue, "enabled"=>true, "getRequest" => true);
  ...
  function addLabel($caption, $name, $value, $hint="", $visible = true, $createHidden = false, $dataType="string", $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="")
  {
    $this->addFormObject('label', $caption, $name, $value, $value, $hint, false, true, false, $visible, $createHidden, $dataType,$arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "");
  }
  
  function addHidden($name, $value="", $enabled = true, $getRequest = true)
  {
    $dataHidden = array("enabled"=>$enabled, 
                        "visible" => 'false', 
                        "type"=>'hidden',
                        "name"=>$name, 
                        "value"=>$value,
  ...
  //e.g. if you provide $clientAction = "onKeyDown='doTest()'" then you must have javascript function called doTest()
  //to Create Hidden field associate with this textbox then pass $createHidden = true;
  function addTextBox($caption, $name, $value, $hint, $readonly=false, $enabled=true, $validate = true, $visible = true, $createHidden = false, $dataType="string", $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="", $size=0, $maxlength=0, $labelWidth = null)
  {
    $this->addFormObject('text', $caption, $name, $value, $value, $hint, $readonly, $enabled, $validate, $visible, $createHidden, $dataType, $arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "", $size, $maxlength, "", $labelWidth);
  }
  
  function addInputFile($caption, $name, $value, $hint, $readonly=false/*when uploaded this will be set readonly*/, $enabled=true, $validate = true, $visible = true, $createHidden = true, $dataType="string", $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="", $size=0, $maxlength=0, $targetFolder = "" /*untuk tipe data file  saja*/)
  {
    $this->hasFile = true;
    $this->addFormObject('file', $caption, $name, $value, $value, $hint, false, $enabled, $validate, $visible, true /*must create hidden to save old file name*/, "string", $arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "", $size, $maxlength, $targetFolder);
  }
  
  function addPassword($caption, $name, $value, $hint, $readonly=false, $enabled=true, $validate = true, $visible = true, $createHidden = false, $dataType="string", $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="", $size=0, $maxlength=0)
  {
    $this->addFormObject('password', $caption, $name, $value, $value, $hint, $readonly, $enabled, $validate, $visible, $createHidden, $dataType, $arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "", $size, $maxlength);
  }

  function addCheckBox($caption, $name, $value, $hint, $readonly=false, $enabled=true, $validate = true, $visible = true, $createHidden = true, $dataType = "", $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="")
  {
    ...
    $this->addFormObject('checkbox', $caption, $name, $value, $value, $hint, $readonly, $enabled, $validate, $visible, true, "", $arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "");
    //return $checkbox;
  }
  
  function addTextArea($caption, $name, $value, $hint, $readonly=false, $enabled=true, $validate = true, $visible = true, $createHidden = false, $dataType="string", $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="",$cols=0, $rows=0)
  {
    $this->addFormObject('textarea', $caption, $name, $value, $value, $hint, $readonly, $enabled, $validate, $visible, $createHidden, $dataType, $arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "", $cols, $rows);
    //return $textarea;
  }
  
  function addLiteral($caption, $name, $literalHTML)
  {
    $this->addFormObject('literal', $caption, $name, $literalHTML, "", "", false, true, false, true, false, DATATYPE_STRING, array(), "", "", "", "", "");
    //return $textarea;
  }
  ...
  //to Create Hidden field associate with this textbox then pass $createHidden = true;
  function addSelect($caption, $name, $value, $hint, $readonly=false, $enabled=true, $validate=true, $visible = true, $createHidden = false, $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="")
  {
    $this->addFormObject('select', $caption, $name, $value, null, $hint, $readonly, $enabled, $validate, $visible, $createHidden, DATATYPE_STRING, $arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "");
  }
  
  function addRadio($caption, $name, $value, $hint, $readonly=false, $enabled=true, $validate=true, $visible = true, $createHidden = false, $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $clientAction="", $col = 0)
  {
    $this->addFormObject('radio', $caption, $name, $value, null, $hint, $readonly, $enabled, $validate, $visible, $createHidden, DATATYPE_STRING, $arrAttribute, $htmlBefore, $htmlAfter, $clientAction, "", $col);
  }
  ...
  function addSubmit($name, $value, $hint, $enabled=true, $visible = true, $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $serverAction="", $clientAction="")
  {
		$arrData = array("enabled"=>$enabled, 
                     "visible" => $visible,
                     "type"=>"submit",
                     "name"=>$name, 
                     "value"=>$value,
  ...
  function addReset($name, $value, $hint, $enabled=true, $visible = true, $arrAttribute = array(), $htmlBefore="", $htmlAfter="", $serverAction="", $clientAction="")
  {
    $arrData = array("enabled"=>$enabled, 
                     "visible" => $visible,
                     "type"=>"reset",
  ...
  function drawObject($obj)
  {
    ...
    switch ($obj['type'])
    {
      case 'select' :
        if ($obj['visible'])
        {
          ...
          else
          {
            ...
            if (!$obj['enabled']) $strResult .= " disabled";
            if ($obj['hint']!="") $strResult .= " title=\"".$obj['hint']."\"";
            $strResult .= ">";
            $isSelected = false;
      ...
      case 'radio' :
        if ($obj['visible'])
        {
          ...
          else
          {
            ...
            if ($obj['attribute']!='') $strPreResult .= " ".$obj['attribute'];
            if (!$obj['enabled']) $strPreResult .= " disabled";
            if ($obj['hint']!="") $strPreResult .= " title=\"".$obj['hint']."\"";
            //$strResult .= ">";
            $isChecked = false;
            $strResult = "";
            foreach($obj['values'] as $key => $opsi)
      ...
      case 'label':
        ...
        {
          if ($this->readonly)
            $strResult = $obj['htmlBefore']."<span id=\"".$obj['name']."\" name=\"".$obj['name']."\">".nl2br(str_replace(" ","&nbsp;",$obj['value']))."&nbsp;</span>".$obj['htmlAfter'];
          else
          {
      ...
      case 'textarea':
        if ($obj['visible'])
        {
          ...
          else
          {
            ...
            if ($obj['size']!=0) $strResult .= " cols=\"".$obj['size']."\"";
            if ($obj['maxlength']!=0) $strResult .= " rows=\"".$obj['maxlength']."\"";
            if ($obj['attribute']!='') $strResult .= " ".$obj['attribute'];
          	if ($obj['readonly']) $strResult .= " readonly";
            if ($obj['hint']!="") $strResult .= " title=\"".$obj['hint']."\"";
            if (!$obj['enabled']) $strResult .= " disabled";
            $strResult .= ">";
      ...
      case 'password' :
        if ($obj['visible'])
        {
          ...
          else
          {
            ...
            {
              if ($obj['maxlength']!=0) $strResult .= " maxlength=\"".$obj['maxlength']."\"";
              if ($obj['size']!=0) $strResult .= " size=\"".$obj['size']."\"";
            }
            if ($obj['attribute']!='') $strResult .= " ".$obj['attribute'];
          	if ($obj['readonly']) $strResult .= " readonly";
            if ($obj['hint']!="") $strResult .= " title=\"".$obj['hint']."\"";
      ...
      case 'checkbox' :
        if ($obj['visible'])
        {
          ...
          else
          {
            ...
            if ($obj['clientAction']!='') $strResult .= " ".$obj['clientAction'];
            if ($obj['attribute']!='') $strResult .= " ".$obj['attribute'];
          	if ($obj['readonly']) $strResult .= " readonly";
            if ($obj['hint']!="") $strResult .= " title=\"".$obj['hint']."\"";
            if (!$obj['enabled']) $strResult .= " disabled";
  ...
  function printFormTag()
  {
    ...
    if ($this->hasFormTag)
    {
      ...
      if ($this->validateEntryBeforeSubmit) $strResult .= " onsubmit=\"return my".$this->formName.".doSubmit();\"";
    ...
    for ($i=0;$i<$this->colCount;$i++)
    {
      ...
      for($j=$i*$jmlBaris; ($j<($i+1)*$jmlBaris && $j<count($this->formObject[$groupNumber])); $j++)
      {
        ...
        if (count($this->formObject[$groupNumber][$j]['labelStyle']) > 0)
          $strResult .= $newLine."                  <td ".$this->serializeAttribute($this->formObject[$groupNumber][$j]['labelStyle']).">".$strCaption."&nbsp;</td>";
        else
        ...
        $strResult .= $newLine."                  <td>".$this->drawObject($this->formObject[$groupNumber][$j])."</td>";
        $strResult .= $newLine."                </tr>";
      }
      $strResult .= $newLine."              </table>";
      $strResult .= $newLine."            </td>";
  ...
  function render()
  {
    ...
    if ($this->hasFormTag) $strResult .= $newLine."      </form>";
    ...
    if ($this->showCaption) $strResult .= $this->writeWindowHelp();
  ...
  function renderContent()
  {
    ...
    for ($i=0;$i<$this->colCount;$i++)
    {
      ...
      {
        $strResult .= $newLine."                <tr valign=\"top\">";
        $strResult .= $newLine."                  <td nowrap>".$this->drawObjectCaption($this->formObject[$j])."</td>";
        $strResult .= $newLine."                  <td width=\"10\">:</td>";
        ...
        switch ($obj['type'])
        {
          ...
          case 'select':
            if ($obj['validate'] == true)
            {
              ...
              $strResult .= $newLine."        alert('".addslashes($validatorErrorMessage[$obj['dataType']].$obj['caption'])."!');";
