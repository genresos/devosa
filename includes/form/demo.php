<?php
  ...
  $f = new clsForm("form1", /*2 column view*/2, "900","500");
  ...
  $f->addTextBox("Vendor Number", "dataCode", $vendorData['code'], "Vendor code", false, true, true, true, false, "string", null,"","","",50,20);
  $f->addTextBox("Company Name", "dataName", $vendorData['companyName'], "Company name", false, true, true, true, false, "string", null,"","","",50,50);
  $f->addTextArea("Office Address", "dataAddress", $vendorData['officeAddress'], "Office Address", false, true, true, true, false, "string", null,"","","",46,2);
  $f->addTextBox("Office Postcode", "dataZip", $vendorData['zipCode'], "Office Postcode", false, true, false, true, false, "string", null,"","","",50,20);
  $f->addTextBox("Office Phone", "dataPhoneNumber", $vendorData['phoneNumber'], "Office Phone", false, true, false, true, false, "string", null,"","","",50,20);

  $f->addTextArea("Factory Address", "dataFactoryAddress", $vendorData['factoryAddress'], "Factory Address", false, true, false, true, false,  "string", null,"","","",46,2);
  $f->addTextBox("Factory Postcode", "dataFactoryZip", $vendorData['factoryZipCode'], "Factory Postcode", false, true, false, true, false, "string", null,"","","",50,10);
  $f->addTextBox("Factory Phone", "dataFactoryPhone", $vendorData['factoryPhone'], "Factory Phone", false, true, false, true, false,  "string", null,"","","",50,20);
  $f->addTextBox("Fax Number", "dataFax", $vendorData['fax'], "Fax Number", false, true, false, true, false,  "string", null,"","","",50,20);
  $f->addTextBox("Email", "dataEmail", $vendorData['email'], "Email", false, true, false, true, false,  "string", null,"","","",50,50);
  $f->addTextBox("Website", "dataWebsite",$vendorData['web'], "Vendor Website", false, true, false, true, false,  "string", null,"","","",50,50);
  $f->addFieldSet("Additional Information");
  $f->addTextBox("Established Date", "dataEstablishDate", $vendorData['establishDate'], "Established Date", false, true, false, true, false,  "date");
  $f->addTextBox("NPWP", "dataNPWP", $vendorData['npwp'], "Vendor NPWP", false, true, false, true, false,  "string", null,"","","",50,50);
  $f->addTextBox("Legal Certificate No.", "dataCertificate", $vendorData['certificate'], "Legal Certificate No.", false, true, false, true, false, "string", null,"","","",50,50);
  $f->addTextBox("Notary", "dataNotary", $vendorData['notary'], "Notary", false, true, false, true, false, "string", null,"","","",50,50);
  $f->addTextArea("Business Line", "dataBusiness", $vendorData['businessLine'], "Business Line", false, true, false, true, false, "string", null,"","","",46,2);
  $f->addSelect("Group", "dataGroup", array(array("value"=>1,"text"=>"Dedy")), "", "Group of User");

  //this save button will hide after save <toggle>
  $f->addSubmit("btnSave", "Save","Save this change", true,true, null, "", "", "saveData()","onClick=\"return confirm('Do you want to save this entry?');\"");
  ...
  $f->addButton("btnCancel", "Cancel","Cancel and back to previous page", true,true,null,"","", "", "onClick='javascript:location.href=\"".$f->getValue('URL_REFERER')."\"'");
