<?php
  ...
  //parameters: same with addColumn at below instruction
  $myDataGrid->addColumnNumbering(new DataGrid_Column("No", "", array('rowspan'=>2 ,'width'=>'30'), array('nowrap'=>''), false, false, "","", "numeric", true, 4));
  //-------------------------------------------------------------------------------------------------
  //Note : addColumn 
  //parameters:
  //   1 : Column Name
  ...
  //   7: Item formatter  
  //-------------------------------------------------------------------------------------------------
  $myDataGrid->addColumn(new DataGrid_Column("ID", "idEmployee", array('rowspan'=>2, 'width' => '100'), array('align' => 'center', 'nowrap' => ''), true, true, "", "printHeaderID()", "string", true, 20));
  $myDataGrid->addColumn(new DataGrid_Column("Date", "attendanceDate", array('rowspan'=>2, 'width' => '250'), array('nowrap' => ''), false, false, "","", "string", true, 20));
  $myDataGrid->addColumn(new DataGrid_Column("Attendance", "", array('colspan' => '3'), array('nowrap' => ''), false, false, "","", "string", true, 20));
  $myDataGrid->addColumn(new DataGrid_Column("Start", "attendanceStart", array('width' => '250'), array('nowrap' => ''), false, false, "","", "string", true, 20));
  $myDataGrid->addColumn(new DataGrid_Column("Finish", "attendanceFinish", null, array('nowrap' => ''), false, false, "","", "string", true, 20));
  $myDataGrid->addColumn(new DataGrid_Column("xxx", "id", null, array('nowrap' => ''), false, false, "","", "string", true, 20));
  $myDataGrid->addColumn(new DataGrid_Column("xxx", "note", array('rowspan'=>2 ), array('nowrap' => ''), false, false, "","", "string", true, 20));
  ...
  $myDataGrid->addSpecialButton("btnApproved","btnApproved","submit","Approved",
    "onClick=\"javascript:return confirm('Do you want to approve this selected data?');\"", "approvedData()");

  $myDataGrid->addSpecialButton("btnDenied","btnDenied","submit","Denied",
    "onClick=\"javascript:return confirm('Do you want to deny this selected data?');\"", "denyData()");
  ...
  $myDataGrid->addButton("btnTest","btnTest","button","Test","onClick=\"javascript: location.href = 'main.php'\"","");
