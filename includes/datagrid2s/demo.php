<?php
  ...
  //parameters: same with addColumn at below instruction
  $myDataGrid->addColumnNumbering(new DataGrid_Column("No", "", array('width'=>'30'), array('nowrap'=>''), false, false, "","", "numeric", true, 4));
  //-------------------------------------------------------------------------------------------------
  //Note : addColumn 
  //parameters:
  //   1 : Column Name
  ...
  //   7: Item formatter  
  //-------------------------------------------------------------------------------------------------
  $myDataGrid->addColumn(new DataGrid_Column("ID", "idEmployee", array('width' => '100'), array('align' => 'center', 'nowrap' => ''), true, true, "", "printHeaderID()", "string", true, 20));
  $myDataGrid->addColumn(new DataGrid_Column("Date", "attendanceDate", array('width' => '250'), array('nowrap' => ''), false, false, "","", "string", true, 20));
