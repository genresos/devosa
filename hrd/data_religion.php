<?php
  ...
  include_once('../classes/hrd/hrd_religion.php');
  ...
  $strSQLCOUNT  = "SELECT COUNT(*) AS total FROM hrd_religion ";
  $strSQL       = "SELECT * FROM hrd_religion ";
...
//--------------------------------------------------------------------------------
  ...
  function saveData() 
  {
    ...
    $dataHrdReligion = new cHrdReligion();
    ...
    if ($isNew)
    {
      ...
      $bolSuccess = $dataHrdReligion->insert($data);
    } 
    else 
    {
      $bolSuccess = $dataHrdReligion->update(/*pk*/"code='".$f->getValue('dataID')."'", /*data to update*/ $data);
    }
    if ($bolSuccess) $f->setValue('dataID', $data['code']);
    
    $f->message = $dataHrdReligion->strMessage;
  } // saveData
  ...
  function deleteData() 
  {
    ...
    $dataHrdReligion = new cHrdReligion();    
    $dataHrdReligion->deleteMultiple($arrKeys);
    
    $myDataGrid->message = $dataHrdReligion->strMessage;
  } //deleteData
