<?php
  ...
  $dataPrivilege = getDataPrivileges("salary_report_tax.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove);
...
//      echo "<br>";
      ...
      $myDataGrid->addColumnNumbering(new DataGrid_Column("No", "", array("rowspan" => 2, 'width'=>'30'), array('nowrap'=>''), false, false, "","", "numeric", true, 4, true, "nomor"));

      $myDataGrid->addColumn(new DataGrid_Column("Name", "employeeName", array("rowspan" => 2), array('nowrap' => ''), true, true, "", "", "string", true, 30));
      $myDataGrid->addColumn(new DataGrid_Column("NPWP", "npwp", array("rowspan" => 2, 'width' => 120), array('align' => 'center'), false, false, "","", "string", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Family Status for Pph21", "familyStatusCodePph21", array("rowspan" => 2, 'width' => 120), array('align' => 'center'), false, false, "","", "string", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Join Date", "joinDate", array("rowspan" => 2, 'width' => 120), array('align' => 'center'), false, false, "","", "string", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Resign Date", "resignDate", array("rowspan" => 2, 'width' => 120), array('align' => 'center'), false, false, "","", "string", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Total Regular Income", "baseTax", array("rowspan" => 2, 'width' => 150), array('align' => 'right'), false, false, "","formatNumerica()", "numeric", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Total Irregular Income", "baseTaxIrregular", array("rowspan" => 2, 'width' => 150), array('align' => 'right'), false, false, "","formatNumerica()", "numeric", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Functional Cost", "jabatanAnnual", array("rowspan" => 2, 'width' => 120), array('align' => 'right'), false, false, "","formatNumerica()", "numeric", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Annual Tax Regular", "taxAnnual", array("rowspan" => 2, 'width' => 120), array('align' => 'right'), false, false, "","formatNumerica()", "numeric", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Annual Tax Irregular", "taxIrregularAnnual", array("rowspan" => 2, 'width' => 120), array('align' => 'right'), false, false, "","formatNumerica()", "numeric", true, 12));
      $myDataGrid->addColumn(new DataGrid_Column("Annual Tax Total", "totalAnnualTax", array("rowspan" => 2, 'width' => 120), array('align' => 'right'), false, false, "","formatNumerica()", "numeric", true, 12));
      ...
      $myDataGrid->addColumn(new DataGrid_Column("Total Monthly", "totalMonthly", array("rowspan" => 2, 'width' => 120), array('align' => 'right'), false, false, "","formatNumerica()", "numeric", true, 12));
...
//    echo $intPage;
    $strSQL  = "SELECT id, EXTRACT(MONTH FROM \"salary_date\") as mon FROM \"hrd_salary_master\" WHERE EXTRACT(YEAR FROM \"salary_date\") = '$intYear' AND status=".REQUEST_STATUS_APPROVED_2;
    ...
    while ($row = $db->fetchrow($res))
    {
        ...
        while ($row2 = $db->fetchrow($res2))
        {
            ...
            $arrResult[$row2['id_employee']]['01'] += ($salaryMasterMonth == 1) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['02'] += ($salaryMasterMonth == 2) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['03'] += ($salaryMasterMonth == 3) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['04'] += ($salaryMasterMonth == 4) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['05'] += ($salaryMasterMonth == 5) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['06'] += ($salaryMasterMonth == 6) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['07'] += ($salaryMasterMonth == 7) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['08'] += ($salaryMasterMonth == 8) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['09'] += ($salaryMasterMonth == 9) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['010'] += ($salaryMasterMonth == 10) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['011'] += ($salaryMasterMonth == 11) ? $row2['tax'] : 0;
            $arrResult[$row2['id_employee']]['012'] += ($salaryMasterMonth == 12) ? $row2['tax'] : 0;
