<?php
  ...
  function getData($db, $bolSync = false) {
    ...
    if ($db->connect())
    {
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("id"), "employee_id", array('rowspan' => '2'),array('nowrap' => '')));
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("calculated ot"), "calculated_ot", array('rowspan' => '2'),array('nowrap' => '')));
  ...
  if ($db->connect()) 
  {
    ...
    $f->addInput(getWords("date from"), "dataDateFrom", ($strDateFrom = getInitialValue("DateFrom", date("Y-m-")."01")), array("style" => "width:$strDateWidth"), "date", false, true, true);
    $f->addInput(getWords("date thru"), "dataDateThru", ($strDateThru = getInitialValue("DateThru", date("Y-m-d"))), array("style" => "width:$strDateWidth"), "date", false, true, true);
