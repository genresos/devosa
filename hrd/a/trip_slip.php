<?php
  ...
  function getData($db)
  {
    ...
    if ($db->connect() && $strDataTripTypeID != "")
    {
      ...
      if ($myDataGrid->sortName == "division_name") $myDataGrid->sortName = "division_name,department_name";  
      ...
      if (substr($strIndex,0,15) == 'DataGrid1_chkID') 
      {
        ...
        {  
		  ...
		  if (($intStatus==-1)||(($rowDb['status']<$intStatus)&&($rowDb['status'] != -1)))
          {
            ...
            writeLog(ACTIVITY_EDIT, MODULE_PAYROLL, $rowDb['employee_name']." - ". $rowDb['created'] ." - ". $rowDb['form_code'], $intStatus);
          }
        }
      }
  ...
  function getSlip()
  {
    ...
    foreach ($myDataGrid->checkboxes as $strDataID)
    {
      ...
      $dataEmployee2 = getEmployeeInfoByID($db, $strIDEmployee, "division_name as division");
