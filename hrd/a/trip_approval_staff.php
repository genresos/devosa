<?php
  ...
  if (!is_numeric($DEFAULTPAGELIMIT)) $DEFAULTPAGELIMIT = 15;
  ...
  function getData($db)
  {
    ...
    if ($db->connect() && $strDataTripTypeID != "")
    {
      ...
      $myDataGrid->pageSortBy = "created asc";
      ...
      $strSQL       = "SELECT t1.*, approver_id, employee_id, t2.position_code, employee_name, division_name, department_name, t2.branch_code || ' - ' || branch_name as branch 
                       FROM hrd_trip AS t1
