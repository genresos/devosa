...
//      $arrData['dataProductCode'] = $strDataProductCode;
  ...
  if ($db->connect()) {
    ...
    $strInputType = getLoanTypeList($db, "dataType", $arrData['dataType'], $strEmptyOption," WHERE category = ".LOAN_FINANCE, "style=\"width:$strDefaultWidthPx\"");
