  ...
  */
  class clsSalaryCalculation
  {
    ...
    */
    ...
    function clsSalaryCalculation($db, $strID = "", $bolIrregular = false, $strDataDate = "", $arrKriteria = array(), $strDateFrom = "", $strDateThru = "")
      ...
      while ($row = $this->data->fetchrow($res))
      {
        ...
        if (isset ($this->arrMA[$row['allowance_code']]) && isset($this->arrDetail[$row['id_employee']]) && $row['amount'] != "")
        {
          ...
          if ($this->arrMA[$row['allowance_code']]['jams'] == 't')
            $this->arrDetail[$row['id_employee']]['base_jamsostek'] = $row['amount']; // as base jamsostek
...
//print_r ($objot);
    ...
    */
	function calculateTHR()
    {
	  ...
	  if ($bolIrregular) $this->arrDA['thr_allowance'][$strIDEmp]["amount"] = 0;
