 ...
 class cDataGrid2 extends cDataGrid
  ...
  function getData($db)
  {
    ...
    if ($db->connect())
    {
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("evaluation date"), "evaluation_date",  "", array('width' => '100', 'valign' => 'top', 'nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("evaluation period"), "evaluation_period",  "", array('width' => '150', 'valign' => 'top', 'nowrap' => '')));
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_name",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("department"), "department_name",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("evaluator"), "evaluator_name",  "", array('width' => '100', 'valign' => 'top', 'nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("total score"), "total_score","", array('align' => 'center', 'nowrap' => ''), false, false, "",""));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("total result"), "total_result","", array('align' => 'center', 'nowrap' => ''), false, false, "",""));
