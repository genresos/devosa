  ...
  function getData($db, $strDataID, &$intRows, $strKriteria = "", $strOrder = "") {
    ...
    if ($strDataID != "") {
      ...
      while ($rowDb = $db->fetchrow($resDb)) {
        ...
        $strResult .= "  <td nowrap>" .getDivisionList($db,"detailDivision$intRows",$rowDb['division_code'],$strEmptyOption,""," style=\"width:$intDefaultWidthPx\" "). "</td>";
        $strResult .= "  <td nowrap>" .getDepartmentList($db,"detailDepartment$intRows",$rowDb['department_code'],$strEmptyOption,""," style=\"width:$intDefaultWidthPx\" "). "</td>";
        $strResult .= "  <td nowrap>" .getSectionList($db,"detailSection$intRows",$rowDb['section_code'],$strEmptyOption,""," style=\"width:$intDefaultWidthPx\" "). "</td>";
        $strResult .= "  <td nowrap>" .getSubSectionList($db,"detailSubSection$intRows",$rowDb['sub_section_code'],$strEmptyOption,""," style=\"width:$intDefaultWidthPx\" "). "</td>";
      ...
      for ($i = 1; $i <= $intAdd; $i++) {
        ...
        $strResult .= "<input type=button id=\"target_$intRows\" value='..'></td>";
        $strResult .= "  <td nowrap>" .getDivisionList($db,"detailDivision$intRows","",$strEmptyOption,""," style=\"width:$intDefaultWidthPx\" $strDisabled "). "</td>";
        $strResult .= "  <td nowrap>" .getDepartmentList($db,"detailDepartment$intRows","",$strEmptyOption, ""," style=\"width:$intDefaultWidthPx\" $strDisabled "). "</td>";
        $strResult .= "  <td nowrap>" .getSectionList($db,"detailSection$intRows","",$strEmptyOption,""," style=\"width:$intDefaultWidthPx\"  $strDisabled"). "</td>";
        $strResult .= "  <td nowrap>" .getSubSectionList($db,"detailSubSection$intRows","",$strEmptyOption,""," style=\"width:$intDefaultWidthPx\" $strDisabled "). "</td>";
