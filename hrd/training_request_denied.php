    ...
    foreach ($_REQUEST as $strIndex => $strValue) {
      if (substr($strIndex,0,5) == 'chkID') {
        ...
        while ($rowDb = $db->fetchrow($resDb)) {
          ...
          $strResult .= "  <td $strRowspan align=center>" .pgDateFormat($rowDb['request_date'], "d-M-y"). "&nbsp;</td>\n";
          ...
          $strResult .= "  <td $strRowspan align=center>" .pgDateFormat($rowDb['training_date'], "d-M-y"). "&nbsp;</td>\n";
