...
class countPPH21
{
	...
	*/
	function __construct($totalMonth = 12, $nonTaxableIncomeArray = null, $filterAnnualizeIncomeTaxNPWP = null, $filterAnnualizeIncomeTaxNonNPWP = null, $roundDownNetIncometo = 3, $filterAnnualizeIncomeTaxGrossUp = null){
		if (is_null($nonTaxableIncomeArray)){
			$this->nonTaxableIncomeArray = array(
				'TK' => 24300000,
				'K0' => 26325000,
				'K1' => 28350000,
				'K2' => 30375000,
		...
		if (is_null($filterAnnualizeIncomeTaxNPWP)){
			...
			$this->filterAnnualizeIncomeTaxNPWP = array(
		...
		if (is_null($filterAnnualizeIncomeTaxNonNPWP)){
			...
			$this->filterAnnualizeIncomeTaxNonNPWP = array(
				$filter1,$filter2,$filter3,$filter4 
			);
		}else{
		...
		if (is_null($filterAnnualizeIncomeTaxGrossUp)){
			...
			$this->filterAnnualizeIncomeTaxGrossUp = array(
				$filter1,$filter2,$filter3,$filter4 
			);
		}else{
