<?
  ...
  */
  ...
  // hasil berupa array
  function getEmployeeLeaveData($db, $strYear, $stremployee_id = "", $strIDEmployee = "", $strSection = "", $strDepartment = "") {
  ...
  // hasil berupa array
  function getEmployeeMedicalPlatformData($db, $strYear, $stremployee_id = "", $strIDEmployee = "", $strSection = "", $strDepartment = "") {
    $arrResult = array();
    ...
    if (!is_numeric($fltPlatformOS)) $fltPlatformOS = 0;

    $strSQL  = "SELECT * FROM hrd_employee WHERE flag = 0 AND active = 1 ";
    if ($stremployee_id != "") $strSQL .= "AND employee_id = '$stremployee_id' ";
    if ($strIDEmployee != "") $strSQL .= "AND id = '$strIDEmployee' ";
    if ($strSection != "") $strSQL .= "AND section_code = '$strSection' ";
    if ($strDepartment != "") $strSQL .= "AND department_code = '$strDepartment' ";
    $resDb = $db->execute($strSQL);
