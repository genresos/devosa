<?php
  ...
  if ($bolCanEdit)
  {
    ...
    $f->addSelect(getWords("training category"), "dataIDCategory", getDataListTrainingCategory($strFilterIDCategory, false), array("style" => "width:270"));

    $f->addInput(getWords("code"), "dataCode", "", array("size" => 50), "string", true, true, true);  
    $f->addInput(getWords("name"), "dataName", "", array("size" => 50), "string", true, true, true);  
  ...
  $fFilter->addSelect(getWords("category"), "filterIDCategory", getDataListTrainingCategory($strFilterIDCategory, true), "", "", false);
  ...
  $myDataGrid->addColumn(new DataGrid_Column(getWords("category"), "training_category", "", array('width' => '200',  'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("code"), "code", "", array('width' => '50',  'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("name"), "name", "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("note"), "note", "", array('valign' => 'top', 'nowrap' => '')));
  if ($bolCanEdit)
