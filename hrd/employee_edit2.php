...
$strWordsFamilyStatus = getWords ("Family Status (Tax) - ptkp ");
...
//$strInputReligion ="";
  ...
  if ($db->connect()) {
    ...
    if ($_SESSION['sessionIdGroup'] == 11 || $_SESSION['sessionIdGroup'] == 12 ||$_SESSION['sessionEmployeeID'] == $arrData['dataEmployeeID'] || ($_SESSION['sessionUserRole'] >= ROLE_ADMIN && $bolNew)) {
