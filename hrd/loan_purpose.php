<?php
  ...
  $dataPrivilege = getDataPrivileges("loan_purpose.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanCheck, $bolCanAcknowledge, $bolCanApprove2);
  ...
  $strWordsListOfLoanPurpose = getWords("list of loan purpose / reason");
   ...
   $strDataID = getPostValue('dataID');
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
      ...
      if ($bolCanEdit)
        ...
        $strResult .= "  <td nowrap>&nbsp;</td>";      $strResult .= "</tr>\n";
    }
    if ($intRows > 0) {
