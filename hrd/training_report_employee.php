<?php
  ...
  function getData($db) {
    ...
    if ($db->connect())
    {
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("employee ID"), "employee_id", "", array('nowrap' => ''), null, null, null, "printNewID()"));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("Name"), "employee_name", "", array('nowrap' => ''), null, null, null, "printNewName()"));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_code", "", array('nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("department"), "department_code", "", array('nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("section"), "section_code", "", array('nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("sub section"), "sub_section_code", "", array('nowrap' => '')));
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("total cost"), "total_cost", null, array('align' => 'right'), false, false, "", "formatNumber()", "numeric", true, 15, true, "total_cost"));

      $myDataGrid->addColumn(new DataGrid_Column(getWords("duration"), "total_hour", null, array('align' => 'right'), false, false, "", "", "numeric", true, 15, true, "total_hour"));
  ...
  if ($db->connect()) 
  {
    ...
    $f->addSelect(getWords("training type"), "dataTrainingType", getDataListTrainingType("", true, array("value" => "", "text" => "", "selected" => true)), array("style" => "width:$strDefaultWidthPx"), "", false);
