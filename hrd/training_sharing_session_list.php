<?php
  ...
  function getData($db, $strDateFrom, $strDateThru, &$intRows, $strKriteria = "", $strOrder = "") 
  {
    ...
    while ($rowDb = $db->fetchrow($resDb)) 
    {
      ...
      if (isset($arrPart1[$rowDb['id_training_request']]))
      {
        ...
        {
          if ($strTrainingParticipant != "") $strTrainingParticipant .= "<br> \n";
      ...
      $strResult .= "  <td align=center><a href=\"training_sharing_session_edit.php?dataID=" .$rowDb['id']. "\">" .getWords('edit'). "</a>&nbsp;</td>";
  ...
  if ($db->connect()) 
  {
    ...
    if (isset($_REQUEST['dataDateFrom'])) $strDateFrom = $_REQUEST['dataDateFrom'];
    if (isset($_REQUEST['dataDateThru'])) $strDateThru = $_REQUEST['dataDateThru'];
    ...
    */
    ...
    $strFilterDepartment = getDepartmentList($db, "dataDepartment",$strDataDepartment, $strEmptyOption,"", "style=\"width:$intDefaultWidthPx\" ");
    $strFilterSection = getSectionList($db, "dataSection",$strDataSection, $strEmptyOption,"", "style=\"width:$intDefaultWidthPx\" ");
