<?php
  ...
  $employeeID='';//employeeID(); Dikosongkan atas permintaan pak Andi supaya saat pembuatan NIK tidak otomatis
  ...
  $f->addSelect(getWords("management"), "management_code", getDataListManagement2($arrData['management_code'], true), array("style" =>"width:250px;"), "string", true, true, true);
  $f->addSelect(getWords("branch office"), "branch_code", getDataListBranch($arrData['branch_code'], true), array("style" =>"width:250px;"), "string", true, true, true);
  $f->addSelect(getWords("branch contract"), "branch_contract_code", getDataListBranch($arrData['branch_contract_code'], true), array("style" =>"width:250px;"), "string", true, true, true);
  $f->addSelect(getWords("cost center"), "branch_cost_center_code", getDataListCostCenter($arrData['branch_cost_center_code'], true), array("style" =>"width:250px;"), "string", true, true, true);
  $f->addSelect(getWords("division"), "division_code", getDataListDivision($arrData['division_code'], true), array("style" =>"width:250px;", "onChange" => "checkDivision()"), "string", true, true, true);
  ...
  $f->addSelect(getWords("grade"), "salary_grade_code", getDataListSalaryGrade($arrData['salary_grade_code'], true, null, true), array("style" =>"width:250px;"), "string", true);
