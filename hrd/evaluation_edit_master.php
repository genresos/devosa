<?php
  ...
  if ($strDataEmployee != "")
  {
    ...
    $arrTemp      = $dataHrdEvaluationCriteriaEmployee->find("active = 't' AND is_last_updated = 't' AND id_employee = '".$arrEmployee['id']."' AND year = $strDataYear", "SUM (weight) AS total_weight");
  ...
  if ($bolCanEdit)
  {
    ...
    $f->addSelect(getWords("evaluation category"), "dataIDCategory", getDataListEvaluationCategory($strDataIDCategory, false, false), array("style" => "width:270"));
    $f->addInput(getWords("employee"), "dataEmployeeTemp", $strDataEmployee, array("size" => 50), "integer", true, false, true);  
    $f->addInput(getWords("weight"), "dataWeight", $fltRemainingWeight, array("size" => 5), "integer", true, true, true);  
    ...
    $f->addTextArea(getWords("target achievement"), "dataTargetAchievement", "", array("cols"=>50, "rows"=>3), "string", false, true, true);
  ...
  $myDataGrid->addColumn(new DataGrid_Column(getWords("target achievement"), "target_achievement", "", array('valign' => 'top', 'align' => 'center', 'width' => '150',)));
  ...
  $myDataGrid->addColumn(new DataGrid_Column(getWords("active"), "", "", array('width' => '15', 'valign' => 'top', 'align' => 'center', 'nowrap' => ''), false, false, "","printActiveSymbol()"));
    if ($bolCanEdit)
...
//--------------------------------------------------------------------------------
  function getScoreTable($strDataID)
  {
    ...
    $strResult .= "<table border=1 cellpadding=1 cellspacing=0>
                   ...
                   <td>".generateInput("dataScore3Note", "", "size=100", "onChange=\"javascript:myClient.setTargetAchievement(this.value);\"")."</td></tr><tr>
