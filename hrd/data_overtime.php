<?php
  ...
  $dataPrivilege = getDataPrivileges("employee_edit.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanCheck, $bolCanAcknowledge, $bolCanApprove2);
  ...
  $arrOvertime = array(
    1 => array("scale" => 0, "note" => "",),
    2 => array("scale" => 0, "note" => "",),
    3 => array("scale" => 0, "note" => "",),
    4 => array("scale" => 0, "note" => "",),
  );
  
  $arrSetting = array(
    "dataMealNormalPermanent" => array("code" => "ot_meal_normal_permanent", "value" => "0", "note" => "meal compensation for ot normal day of permanent", "default" => "0"),
    "dataMealNormalOutsource" => array("code" => "ot_meal_normal_outsource", "value" => "0", "note" => "meal compensation for ot normal day of outsource", "default" => "0"),
    "dataMealHolidayPermanent" => array("code" => "ot_meal_holiday_permanent", "value" => "0", "note" => "meal compensation for ot holiday of permanent", "default" => "0"),
    "dataMealHolidayOutsource" => array("code" => "ot_meal_holiday_outsource", "value" => "0", "note" => "meal compensation for ot holiday of outsource", "default" => "0"),
    "dataTransportNormalPermanent" => array("code" => "ot_transport_normal_permanent", "value" => "0", "note" => "transport compensation for ot normal day of permanent", "default" => "0"),
    "dataTransportNormalOutsource" => array("code" => "ot_transport_normal_outsource", "value" => "0", "note" => "transport compensation for ot normal day of outsource", "default" => "0"),
    "dataTransportHolidayPermanent" => array("code" => "ot_transport_holiday_permanent", "value" => "0", "note" => "transport compensation for ot holiday of permanent", "default" => "0"),
    "dataTransportHolidayOutsource" => array("code" => "ot_transport_holiday_outsource", "value" => "0", "note" => "transport compensation for ot holiday of outsource", "default" => "0"),
    "dataTransportLimitNormal" => array("code" => "ot_transport_normal_limit", "value" => "21:00:00", "note" => "time limit for transport compensation normalday", "default" => "21:00:00"),
    "dataMealLimit1" => array("code" => "ot_meal_limit1", "value" => "4", "note" => "duration limit for meal compensation 1rst", "default" => "4"),
    "dataMealLimit2" => array("code" => "ot_meal_limit2", "value" => "8", "note" => "duration limit for meal compensation 2nd", "default" => "8"),
    "dataMealLimit3" => array("code" => "ot_meal_limit3", "value" => "8", "note" => "duration limit for meal compensation 3rd", "default" => "8"),
  );
  //----------------------------------------------------------------------
  ...
  function saveData($db, &$strError) {
    ...
    foreach ($arrOvertime AS $i => $arrLembur) 
    {
      ...
      $data = array("scale" => $intAmount,
                    "note" => $strNote,
                    "code" => "L$i");
      if ($rowDb = $tblOvertimeType->findByCode('L$i'))
      {
        $tblOvertimeType->update(array("code" => "L$i"), $data);
      } 
      else 
      { // create
        $tblOvertimeType->insert($data);
    ...
    foreach ($arrSetting AS $kode => $arrData) 
    {
      if (isset($_REQUEST[$kode])) 
      {
        ...
        $tblSetting->update(array("code" => $arrData['code']), array("value" => $strValue));
      }
    }
    ...
    $data = array("code" => $_REQUEST['dataCode'],
		...
		{
			$tbl->update(array("code" => $_REQUEST['dataCode']), $data);
		}
