<?php
  ...
  function getEmployeeInfo($db, $strIDEmployee = "", $strDateFrom = "", $strDateThru = "", $stremployee_id = "") {
    ...
    $resDb = $db->execute($strSQL);
    if ($rowDb = $db->fetchrow($resDb)) {
      if ($rowDb['total'] != "") $strWarningInfo = $rowDb['total'];
    }
    ...
    if (isset($arrAbs[$strIDEmployee]['total'])) $strAbsenceInfo = $arrAbs[$strIDEmployee]['total'];
    if (isset($arrAtt[$strIDEmployee]['late'])) $strLateInfo = $arrAtt[$strIDEmployee]['late'];
    if (isset($arrAtt[$strIDEmployee]['early'])) $strEarlyInfo = $arrAtt[$strIDEmployee]['early'];
