<?php
  ...
  function getData($db)
  {
    ...
    if ($db->connect())
    {
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getwords("n i k"), "employee_id", array('width' => '150'), array('nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("employee name"), "employee_name", array('width' => '150'), array('nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_code", array('width' => '75'), array('align' => 'center'), true, true, "", "getDivisionName()", "", true));
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("counter"), "counter", array('width' => '75'), array('align' => 'center'), true, true, "", "", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("leave allowance"), "leave_allowance", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumber()", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("tax"), "tax", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumber()", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("zakat"), "zakat", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumber()", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("net"), "leave_allowance_net", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumber()", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("leave allowance date"), "leave_allowance_date", array('width' => '75'), array('align' => 'center'), false, false, "", "", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("calculated"), "calculated", array('width' => '75'), array('align' => 'center'), false, false, "", "", "", true));
      ...
      if (substr($strIndex,0,15) == 'DataGrid1_chkID') 
      {
        ...
        {  
          ...
          if (isProcessable($rowDb['status'], $intStatus))
          {
            ...
            writeLog(ACTIVITY_EDIT, MODULE_PAYROLL, $rowDb['employee_name']." - ". $rowDb['leave_allowance_date'] ." - ". $rowDb['leave_allowance'], $intStatus);
          }
        }
      }
  ...
  if ($db->connect()) 
  {
    ...
    $f->addInputAutoComplete(getwords("n i k"), "dataEmployeeID", getDataEmployee($strDataEmployee), "style=width:$strDefaultWidthPx ".$strReadonly, "string", false);
