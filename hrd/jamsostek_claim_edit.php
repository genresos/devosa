<?php
  ...
  $strWordsMoneyRewards         = getWords ("money rewards"). " (". getWords ("basic salary") ." ". getWords ("and") ." ". getWords ("allowance").")";
  ...
  if ($db->connect()) {
    ...
    $strReadonly = (scopeGeneralDataEntry($arrData['dataEmployee'], $_SESSION['sessionUserRole'], $arrUserInfo, $bolIsNew)) ? "readonly" : "";
    ...
    $strInputAccidentAftermath    = "<input type=radio name=inputDataAftermath id=inputDataAftermath0 value=0>".getWords("death")."</input><br>
                                    <input type=radio name=inputDataAftermath id=inputDataAftermath1 value=1>".getWords("sick")."</input><br>
                                    <input type=radio name=inputDataAftermath id=inputDataAftermath2 value=2>".getWords("wounded")."</input><br>";
    
    $tempAftermath = $arrData['dataAftermath'];
    if(empty($tempAftermath)) $tempAftermath = 0;
    ...
    $strInputPatientStatus        = "<input type=radio name=inputDataPatientStatus id=inputDataPatientStatus0 value=0>".getWords("outpatient")." : ".getWords("work")."</input><br>
                                    <input type=radio name=inputDataPatientStatus id=inputDataPatientStatus1 value=1>".getWords("outpatient")." : ".getWords("does not work")."</input><br>
                                    <input type=radio name=inputDataPatientStatus id=inputDataPatientStatus2 value=2>".getWords("inpatient")." : ".getWords("hospital")."</input><br>
                                    <input type=radio name=inputDataPatientStatus id=inputDataPatientStatus3 value=3>".getWords("inpatient")." : ".getWords("puskesmas")."</input><br>
                                    <input type=radio name=inputDataPatientStatus id=inputDataPatientStatus4 value=4>".getWords("inpatient")." : ".getWords("poliklinik")."</input><br>";
    
    $tempPS = $arrData['dataPatientStatus'];
    if(empty($tempPS)) $tempPS = 0;
    ...
    $strInputLaborWage            = "<input type=radio name=inputDataLaborWage id=inputDataLaborWage0 value=0>".getWords("one day")."</input>
                                    <input type=radio name=inputDataLaborWage id=inputDataLaborWage1 value=1>".getWords("one month")."</input>
                                    <input type=radio name=inputDataLaborWage id=inputDataLaborWage2 value=2>".getWords("contract")."</input>";
  
    $tempLW = $arrData['dataLaborWage'];
    if(empty($tempLW)) $tempLW = 0;
    ...
    $strInputAccidentType         = "<input type=radio onchange='setFirstQuestion(0)' name=inputDataAccType id=inputDataAccType0 value=0>".getWords("accident")."</input><br>
                                    <input type=radio onchange='setFirstQuestion(1)' name=inputDataAccType id=inputDataAccType1 value=1>".getWords("illness caused from workplace")."</input><br>";
    
    $tempAccType = $arrData['dataAccType'];
    if(empty($tempAccType)) $tempAccType = 0;
