<?
  ...
  $dataPrivilege = getDataPrivileges("attendance_edit_by_employee.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanCheck, $bolCanAcknowledge, $bolCanApprove2);
