<?php
  ...
  $dataPrivilege = getDataPrivileges("overtime_fee_summary.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanCheck, $bolCanAcknowledge, $bolCanApprove2);
  ...
  function getData($db, $strDataID)
  {
    ...
    if ($db->connect())
    {
      ...
      $myDataGrid->addColumn(new DataGrid_Column(getWords("employee id"), "employee_id", array('width' => '150'), array('nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("employee name"), "employee_name", array('width' => '250'), array('nowrap' => '')));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("grade"), "grade_code", array('width' => '50'), array(), true, true, "", "", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_code", array('width' => '150'), array(), true, true, "", "getDivisionName()", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("department"), "department_code", array('width' => '150'), array(), true, true, "", "getDepartmentName()", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("section"), "section_code", array('width' => '75'), array('align' => 'center'), true, true, "", "getSectionName()", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("branch"), "branch", array('width' => '75'), array(), true, true, "", "", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("bank"), "bank2_code", array('width' => '75'), array(), true, true, "", "", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("bank account"), "bank2_account", array('width' => '100'), array(), true, true, "", "", "string", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("bank account name"), "bank2_account_name", array('width' => '175'), array(), true, true, "", "", "", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("transport allowance"), "transport_allowance", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumeric()", "numeric", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("meal allowance"), "meal_allowance", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumeric()", "numeric", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("breakfast allowance"), "breakfast_allowance", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumeric()", "numeric", true));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("total"), "total_allowance", array('width' => '75'), array('align' => 'center'), false, false, "", "formatNumeric()", "numeric", true));
      ...
      if (substr($strIndex,0,15) == 'DataGrid1_chkID') 
      {
        ...
        {  
          ...
          if (isProcessable($rowDb['status'], $intStatus))
          {
            ...
            writeLog(ACTIVITY_EDIT, MODULE_PAYROLL, $rowDb['employee_name']." - ". $rowDb['date_from'] ." - ". $rowDb['date_thru'], $intStatus);
          }
        }
      }
