  ...
  */
  class clsCommonShift
  {
    ...
    */
    ...
    {
       if ($strDateFrom <= $strDateTo) return false;
       ...
       {
          $arrTemp = $this->getPrevSchedule($this->data, $strIDEmployee, $this->objDate->getNextDate($strDateFrom, -1),$strDateTo );
       }
    }
    ...
    */
    function getTotalWorkingShift($strDateFrom, $strDateTo, $strIDEmployee = "")
    {
      ...
      if ($strIDEmployee != "") $arrResult[$strIDEmployee] = $intInterval;
