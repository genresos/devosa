<?php
  ...
  if ($db->connect()) {
    ...
    $strInputPatientStatus        = "<input type=radio name=inputPatientStatus id=inputPatientStatus0 value=0>".getWords("cannot work until")." 'Date Determined'</input><br>
                                    <input type=radio name=inputPatientStatus id=inputPatientStatus1 value=1>".getWords("permanently disabled")."</input><br>
                                    <input type=radio name=inputPatientStatus id=inputPatientStatus2 value=2>".getWords("permanently disabled, physically or mentally")."</input><br>
                                    <input type=radio name=inputPatientStatus id=inputPatientStatus3 value=3>".getWords("died")."</input><br>";
