<?php
  ...
  $strWordsLISTOFDIVISIONDEPARTMENTANDSECTION = getWords ("list of division, departmen and section");
  ...
  { 
    ...
    $strSQL .= "WHERE management_code LIKE '".printCompanyCode($_SESSION['sessionCAR'])."%' $strKriteria ORDER BY $strOrder management_code ";
    ...
    while ($rowMan = $db->fetchrow($resMan)) {
     $intRows++;
      ...
      $strResult .= "  <td><input type=checkbox name='chkManagementID$intRows' value=\"" .$rowMan['id']. "\"></td>\n";
      $strResult .= "  <td nowrap><input type=text name=detailManagementCode$intRows value=\"" .$rowMan['management_code']. "\" disabled>" .$rowMan['management_code']. "&nbsp;</td>\n";
      $strResult .= "  <td><input type=text name=detailManagementName$intRows value=\"" .$rowMan['management_name']. "\" disabled>" .$rowMan['management_name']. "&nbsp;</td>\n";
      $strResult .= "  <td nowrap align=center><a href='javascript:editDataManagement($intRows)'>" .$strWordEdit. "</a>&nbsp;</td>\n";
      $strResult .= "  <td nowrap align=center><a href='javascript:addDataDivision($intRows)'><img src=\"../images/add.png\" border=0 alt='Add' title='" .$words['add department']. "' /></a>&nbsp;</td>\n";
      ...
      while ($rowDiv = $db->fetchrow($resDiv)) {
       ...
       $intDiv++;
        ...
        if ($intDiv > 1) { //baris baru
          $intRows++;
          $strResult .= "<tr valign=top>\n";
          $strHidden  = "<input type=text name='chkManagementID$intRows' value=\"" .$rowMan['id']. "\" disabled>";
          $strHidden .= "<input type=text name='detailManagementCode$intRows' value=\"" .$rowMan['management_code']. "\" disabled>";
          $strHidden .= "<input type=text name='detailManagementName$intRows' value=\"" .$rowMan['management_name']. "\" disabled>";
          $strResult .= "<td colspan=5>$strHidden&nbsp;</td>\n";

        }
        $strResult .= "  <td><input type=checkbox name='chkDivisionID$intRows' value=\"" .$rowDiv['id']. "\"></td>\n";
        $strResult .= "  <td nowrap><input type=text name=detailDivisionCode$intRows value=\"" .$rowDiv['division_code']. "\" disabled>" .$rowDiv['division_code']. "&nbsp;</td>\n";
        $strResult .= "  <td><input type=text name=detailDivisionName$intRows value=\"" .$rowDiv['division_name']. "\" disabled>" .$rowDiv['division_name']. "&nbsp;</td>\n";
        $strResult .= "  <td nowrap align=center><a href='javascript:editDataDivision($intRows)'>" .$strWordEdit. "</a>&nbsp;</td>\n";
        $strResult .= "  <td nowrap align=center><a href='javascript:addData($intRows)'><img src=\"../images/add.png\" border=0 alt='Add' title='" .$words['add department']. "' /></a>&nbsp;</td>\n";
        ...
        while ($rowDb = $db->fetchrow($resDb)) {
          ...
          if ($intDept > 1) { //baris baru
            $intRows++;
            $strResult .= "<tr valign=top>\n";
            $strHidden  = "<input type=text name='chkDivisionID$intRows' value=\"" .$rowDiv['id']. "\" disabled>";
            $strHidden .= "<input type=text name='detailManagementCode$intRows' value=\"" .$rowMan['management_code']. "\" disabled>";
            $strHidden .= "<input type=text name='detailManagementName$intRows' value=\"" .$rowMan['management_name']. "\" disabled>";
            $strHidden .= "<input type=text name='detailDivisionCode$intRows' value=\"" .$rowDiv['division_code']. "\" disabled>";
            $strHidden .= "<input type=text name='detailDivisionName$intRows' value=\"" .$rowDiv['division_name']. "\" disabled>";
            $strResult .= "<td colspan=5>$strHidden&nbsp;</td>\n";
            $strResult .= "<td colspan=5>&nbsp;</td>\n";
          }

          $strResult .= "  <td><input type=checkbox name='chkID$intRows' value=\"" .$rowDb['id']. "\"></td>\n";
          $strResult .= "  <td nowrap><input type=text name=detailCode$intRows value=\"" .$rowDb['department_code']. "\" disabled>" .$rowDb['department_code']. "&nbsp;</td>\n";
          $strResult .= "  <td><input type=text name=detailName$intRows value=\"" .$rowDb['department_name']. "\" disabled>" .$rowDb['department_name']. "&nbsp;</td>\n";
          $strResult .= "  <td nowrap align=center><a href='javascript:editData($intRows)'>" .$strWordEdit. "</a>&nbsp;</td>\n";
          $strResult .= "  <td nowrap align=center><a href='javascript:addDataSection($intRows)'><img src=\"../images/add.png\" border=0 alt='Add' title='" .$words['add section']. "' /></a>&nbsp;</td>\n";
          ...
          while ($rowSec = $db->fetchrow($resSec)) {
            ...
            if ($intSection > 1) { //baris baru
              $intRows++;
              $strResult .= "<tr valign=top>\n";
              $strHidden  = "<input type=text name='chkID$intRows' value=\"" .$rowDb['id']. "\" disabled>";
              $strHidden .= "<input type=text name='detailManagementCode$intRows' value=\"" .$rowMan['management_code']. "\" disabled>";
              $strHidden .= "<input type=text name='detailManagementName$intRows' value=\"" .$rowMan['management_name']. "\" disabled>";
              $strHidden .= "<input type=text name='detailDivisionCode$intRows' value=\"" .$rowDiv['division_code']. "\" disabled>";
              $strHidden .= "<input type=text name='detailDivisionName$intRows' value=\"" .$rowDiv['division_name']. "\" disabled>";
              $strHidden .= "<input type=text name='detailCode$intRows' value=\"" .$rowDb['department_code']. "\" disabled>";
              $strHidden .= "<input type=text name='detailName$intRows' value=\"" .$rowDb['department_name']. "\" disabled>";
              $strResult .= "  <td colspan=5>$strHidden&nbsp;</td>\n";
              $strResult .= "  <td colspan=5>&nbsp;</td>\n";
              $strResult .= "  <td colspan=5>&nbsp;</td>\n";
            ...
            $strResult .= "  <td><input type=checkbox name='chkSectionID$intRows' value=\"" .$rowSec['id']. "\"></td>\n";
            $strResult .= "  <td nowrap><input type=text name=detailSectionCode$intRows value=\"" .$rowSec['section_code']. "\" disabled>" .$rowSec['section_code']. "&nbsp;</td>\n";
            $strResult .= "  <td><input type=text name=detailSectionName$intRows value=\"" .$rowSec['section_name']. "\" disabled>" .$rowSec['section_name']. "&nbsp;</td>\n";
            $strResult .= "  <td nowrap align=center><a href='javascript:editDataSection($intRows)'>" .$strWordEdit. "</a>&nbsp;</td>\n";
            $strResult .= "  <td nowrap align=center><a href='javascript:addDataSubSection($intRows)'><img src=\"../images/add.png\" border=0 alt='Add' title='" .$words['add subsection']. "' /></a>&nbsp;</td>\n";
            ...
            while ($rowSub = $db->fetchrow($resSub)) {
              ...
              if ($intSubSection > 1) { //baris baru
                ...
                $strHidden .= "<input type=text name='detailCode$intRows' value=\"" .$rowDb['department_code']. "\" disabled>";
                $strHidden .= "<input type=text name='detailName$intRows' value=\"" .$rowDb['department_name']. "\" disabled>";
                $strHidden .= "<input type=text name='detailSectionCode$intRows' value=\"" .$rowSec['section_code']. "\" disabled>";
                $strHidden .= "<input type=text name='detailSectionName$intRows' value=\"" .$rowSec['section_name']. "\" disabled>";
                $strResult .= "  <td colspan=5>$strHidden&nbsp;</td>\n";
                $strResult .= "  <td colspan=5>&nbsp;</td>\n";
                $strResult .= "  <td colspan=5>&nbsp;</td>\n";
                $strResult .= "  <td colspan=5>&nbsp;</td>\n";
              ...
              $strResult .= "  <td><input type=checkbox name='chkSubSectionID$intRows' value=\"" .$rowSub['id']. "\"></td>\n";
              $strResult .= "  <td nowrap><input type=text name=detailSubSectionCode$intRows value=\"" .$rowSub['sub_section_code']. "\" disabled>" .$rowSub['sub_section_code']. "&nbsp;</td>\n";
              $strResult .= "  <td><input type=text name=detailSubSectionName$intRows value=\"" .$rowSub['sub_section_name']. "\" disabled>" .$rowSub['sub_section_name']. "&nbsp;</td>\n";
  ...
  function saveData($db, &$strError) 
  {
    ...
    if (strtolower($strDataType) == "management") 
    {
      ...
      else 
      {
        ...
        if (isDataExists("hrd_management","management_code",$strDataCode,$strKriteria)) 
        {
      ...
      // simpan data -----------------------
      $data = array("management_code" => $strDataCode, 
                    "management_name" => $strDataName,
                    );
      ...
      {
        $tbl->update(array("id" => $strDataID), $data);
    ...
    {  
      ...
      {
        ($strDataID == "") ? $strKriteria = "" : $strKriteria = "AND id <> '$strDataID' ";
        if (isDataExists("hrd_division","division_code",$strDataCode,$strKriteria)) 
        {
          $strError = $error['duplicate_code']. "  -> $strDataCode";
          return false;
        }
      ...
      // simpan data -----------------------
      $data = array("division_code" => $strDataCode, 
    ...
    { 
      ...
      if ($strDataCode == "") {
        ...
        ($strDataID == "") ? $strKriteria = "" : $strKriteria = "AND id <> '$strDataID' ";
        if (isDataExists("hrd_department", "department_code",$strDataCode,$strKriteria)) {
          $strError = $error['duplicate_code']. "  -> $strDataCode";
          return false;
        }
      }

      $data = array("department_code" => $strDataCode, 
    ...
    else if (strtolower($strDataType) == "section") 
    { // --- EDIT DATA SECTION
      (isset($_REQUEST['dataManCode'])) ? $strDataManCode = $_REQUEST['dataManCode'] : $strDataManCode = "";
      (isset($_REQUEST['dataDivCode'])) ? $strDataDivCode = $_REQUEST['dataDivCode'] : $strDataDivCode = "";
      ...
      else 
      {
        /*
        ($strDataID == "") ? $strKriteria = "" : $strKriteria = "AND id <> '$strDataID' ";
        if (isDataExists($db,"hrdDepartment","departmentCode",$strDataCode,$strKriteria)) {
          $strError = $error['duplicate_code']. "  -> $strDataCode";
          return false;
        }
        */
      ...
      $data = array("section_code" => $strDataCode, 
    ...
    else if (strtolower($strDataType) == "subsection") 
    { // --- EDIT DATA SUBSECTION
      (isset($_REQUEST['dataManCode'])) ? $strDataManCode = $_REQUEST['dataManCode'] : $strDataManCode = "";
      (isset($_REQUEST['dataDivCode'])) ? $strDataDivCode = $_REQUEST['dataDivCode'] : $strDataDivCode = "";
      (isset($_REQUEST['dataDeptCode'])) ? $strDataDeptCode = $_REQUEST['dataDeptCode'] : $strDataDeptCode = "";
      ...
      $data = array("sub_section_code" => $strDataCode, 
  ...
  if ($db->connect()) 
  {
    ...
    if (isset($_REQUEST['btnSave'])) 
    {
      ...
      else echo "<script>alert(\"Sorry, you do not have authority to modify data in this page\")</script>";
    } 
