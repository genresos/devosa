<?
  ...
  $dataPrivilege = getDataPrivileges(basename($_SERVER['PHP_SELF']), $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanClose);
  ...
  if ($db->connect()) {
    ...
    $strKriteria = "";
    if ($arrUserInfo['isDeptHead'] && $_SESSION['sessionUserRole'] == ROLE_EMPLOYEE) $strFilterDepartment = $arrUserInfo['department_code'];
    else if ($arrUserInfo['isGroupHead'] && $_SESSION['sessionUserRole'] == ROLE_EMPLOYEE) $strFilterDepartment = $arrUserInfo['department_code'];
