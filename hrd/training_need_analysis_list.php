<?php
  ...
  if (isset($_REQUEST['dataSubSection']))     $strDataSection    = $_REQUEST['dataSubSection'];
  ...
  if ($bolCanView)
  {
    ...
    $f->addSelect(getWords("division"), "dataDivision", getDataListDivision($strDataDivision, true), array("style" => "width:270"));
    $f->addSelect(getWords("department"), "dataDepartment", getDataListDepartment($strDataDepartment, true), array("style" => "width:270"));
    $f->addSelect(getWords("section"), "dataSection", getDataListSection($strDataSection, true), array("style" => "width:270"));
    $f->addSelect(getWords("sub section"), "dataSubSection", getDataListSubSection($strDataSubSection, true), array("style" => "width:270"));
    $f->addSelect(getWords("level"), "dataPosition", getDataListPosition($strDataPosition, true), array("style" => "width:270"));
    $f->addSelect(getWords("grade"), "dataGrade", getDataListSalaryGrade($strDataGrade, true), array("style" => "width:270"));

   
    $f->addInputAutoComplete(getWords("employee"), "dataEmployee", getDataEmployee($strDataEmployeeID), array("size" => 50), "string", false);
  ...
  $myDataGrid->addColumn(new DataGrid_Column(getWords("created date"), "created_date",  "", array('width' => '100', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("employee id"), "employee_id",  "", array('width' => '100', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("employee name"), "employee_name",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_code",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("department"), "department_code",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("grade"), "grade_code",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("job title"), "job_title",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("job description"), "job_description",  "", array('width' => '200', 'valign' => 'top', 'nowrap' => '')));

  foreach($dataTrainingCategory as $strIDCategory => $arrCategory)
  {
    $myDataGrid->addColumn(new DataGrid_Column($arrCategory['training_category'], "category_".$strIDCategory, "", array('align' => 'center', 'nowrap' => ''), false, false, "",""));
  }
 ...
 /* if ($strDataIDCategory != "")
  ...
  {
    $dataTNADetailByType = $tblTNADetailByType->findAll("id_master = '".$arrDetail['id']."'", null, "", null, 1, "id_category"); 
