...
/*    print_r($_REQUEST);
  ...
  if ($db->connect()) {
    ...
    $strLegend .= "  <td nowrap>" .getWords('national event'). "&nbsp;</td></tr>";
    $strLegend .= "  <tr><td class='bgCompanyHoliday' width=20>&nbsp;</td>";
    $strLegend .= "  <td nowrap>" .getWords('company event'). "&nbsp;</td></tr>";
    $strLegend .= "  <tr><td class='bgSpecialHoliday' width=20>&nbsp;</td>";
    $strLegend .= "  <td nowrap>" .getWords('special event'). "&nbsp;</td></tr>";
    $strLegend .= "  <tr><td class='bgLeaveHoliday' width=20>&nbsp;</td>";
    $strLegend .= "  <td nowrap>" .getWords('leave'). "&nbsp;</td></tr>";
    $strLegend .= "</table>\n";
  }
  ...
  $strMonthNavigation .= "<strong><a href=working_calendar.php?dataMonth=$intPrevMonth&dataYear=$intPrevYear>" .getBulanSingkat((int)$intPrevMonth). " ". $intPrevYear. "</a> ";
  $strMonthNavigation .= " | " .getBulan((int)$strDataMonth). " ".$strDataYear. " | ";
  $strMonthNavigation .= "<a href=working_calendar.php?dataMonth=$intNextMonth&dataYear=$intNextYear>" .getBulanSingkat((int)$intNextMonth). " ". $intNextYear. "</a></strong> ";
