...
//      $arrData['dataProductCode'] = $strDataProductCode;
  ...
  if ($db->connect()) {
    ...
    $strInputType = getLoanTypeList($db, "dataType", $arrData['dataType'], $strEmptyOption,"", "style=\"width:$strDefaultWidthPx\"");
...
//    $strInputProductType = getLoanProductTypeList($db, "dataProductType", $arrData['dataProductType'], $strEmptyOption,"", "style=\"width:$strDefaultWidthPx\"");
    ...
    $strResult  = "<tr><td>Name</td><td>:</td><td>".$rowDb['employee_name']."<td></tr>\n";
    $strResult .= "<tr><td>&nbsp;</tr>\n";
    $strResult .= "<tr><td>Branch</td><td>:</td><td>".getBranchName($rowDb['branch_code'])."<td></tr>\n";
    $strResult .= "<tr><td>Branch Penugasan</td><td>:</td><td>".getBranchName($rowDb['branch_penugasan_code'])."<td></tr>\n";
    $strResult .= "<tr><td>Division</td><td>:</td><td>".getDivisionName($rowDb['division_code'])."<td></tr>\n";
    $strResult .= "<tr><td>Deparment</td><td>:</td><td>".getDepartmentName($rowDb['department_code'])."<td></tr>\n";
    $strResult .= "<tr><td>Section</td><td>:</td><td>".getSectionName($rowDb['section_code'])."<td></tr>\n";
    $strResult .= "<tr><td>Sub Section</td><td>:</td><td>".getSubSectionName($rowDb['sub_section_code'])."<td></tr>\n";
    $strResult .= "<tr><td>&nbsp;</tr>\n";
    $strResult .= "<tr><td>Status</td><td>:</td><td>".printEmployeeStatus2($rowDb['employee_status'])."<td></tr>\n";
    $strResult .= "<tr><td>Contract Due</td><td>:</td><td>".pgDateFormat($rowDb['due_date'], "d-M-y")."<td></tr>\n";
    echo $strResult;
    die();
    }
