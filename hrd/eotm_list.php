...
$f->addLabelAutoComplete("", "dataEmployeeID", "");
    $f->addSelect(getWords("release month"), "dataMonth", getDataListMonth(date("m"), true, $arrEmpty ), "style='width:250px'", "", false);
    $f->addSelect(getWords("release year"), "dataYear", getDataListYear(date("Y"), true, $arrEmpty ), "style='width:250px'", "", false);
