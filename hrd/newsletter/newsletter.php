            ...
            <td  align='left' class='pageHeaderTitle'>
              <table border='0' cellspacing='0' cellpadding='2'>
                <tr>
                  ...
                  <td nowrap class='pageHeaderTitleText'>Newsletter</td><td><a href='main.php'>Back</a></td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td>
					<div>
						...
						url=http://localhost/hr/hrd/newsletter/newsletter.pdf&amp;embedded=true' width='100%' height='400'/>
					</div>
			</td>
          </tr>
        </table>
