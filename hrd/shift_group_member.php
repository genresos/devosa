<?
  ...
  if ($db->connect()) {
    ...
    $strFilterDepartment = getDepartmentList($db, "filterDepartment", $strDataDepartment, $strEmptyOption, "", "style=\"width:$intWidthPx\"");
    $strFilterSection = getSectionList($db, "filterSection", $strDataSection, $strEmptyOption, "", "style=\"width:$intWidthPx\"");
