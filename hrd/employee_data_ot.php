<?
  ...
  */
  ...
  if ($db->connect()) {
    ...
    $strNickTokens = "";
    $i = 0;
    $strSQL = "SELECT id, employee_id, employee_name FROM hrd_employee as A1
			   LEFT JOIN hrd_position as A2 ON A1.position_code=A2.position_code	
	           WHERE 1=1 AND A2.get_ot!=0 ";
	  getUserEmployeeInfo();
