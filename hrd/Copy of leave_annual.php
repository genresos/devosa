<?php
  ...
  function getData($db, &$intRows, $strKriteria = "", $intPage = 1, $bolLimit = true, $strOrder = "") {
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
	  ...
	  /*
	  if($arrCuti['prev_additional']!="") $intLeaveAdditionalPrev = $arrCuti['prev_additional'];
	  if($arrCuti['curr_additional']!="") $intLeaveAdditionalCurr = $arrCuti['curr_additional'];
	  */
      ...
      $strResult .= "  <td align=center title='" .$arrCuti['prev']['finish']."'>$strPrevLeaveText </td>";
     ...
     //$strResult .= "  <td align=center title='" .$arrCuti['curr']['finish']."'>$strCurrYear</td>";
      $strResult .= "  <td align=center title='" .$arrCuti['curr']['finish']."'>$strCurrLeaveText</td>";
