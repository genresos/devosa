<?php
  ...
  if ($db->connect()) 
  {
    ...
    $fFilter->addSelect(getWords("request status"), "dataRequestStatus", getDataListRequestStatus($arrData['dataRequestStatus'], true, array("value" => "", "text" => "", "selected" => true)), "style=width:$strDefaultWidthPx ", "", false);  
...
//--------------------------
  ...
  {   
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("bank account"), "bank2_account", "",  array("align" => "center"), true, true, "", "", "string", true, 20));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("bank"), "bank_name", "",  array("align" => "center"), true, true, "", "", "string", true, 20));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("bank account name"), "bank2_account_name", "",  array("align" => "center"), true, true, "", "", "string", true, 35));
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_name", array("width" => 100),  array("nowrap" => "nowrap"), true, true, "", "", "string", false));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("department"), "department_name", "",  array("nowrap" => "nowrap"), true, true, "", "", "string", false));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("section"), "section_name", array("width" => 100),  array("nowrap" => "nowrap"), true, true, "", "", "string", false));
    ...
    $strSQL       = "
      SELECT t1.id, employee_id, employee_name, bank_name, id_company, id_trip_type, 
      division_name, department_name, section_name, 
      t1.division_code, t1.department_code, t1.section_code, 
      branch_code, bank2_account, bank2_account_name, ";
    ...
    $strSQL    .= "
      ...
      ";
    $strSQL .= " GROUP BY t1.id, id_trip_type, employee_id, employee_name, bank2_account, bank2_account_name, bank_name, id_company, t1.division_code, t1.department_code, t1.section_code,division_name , department_name , section_name , branch_code ";
