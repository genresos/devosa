<?php
  ...
  $dataPrivilege = getDataPrivileges("salary_calculation.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanCheck, $bolCanAcknowledge, $bolCanApprove2);
...
<table>
  ...
  function getDataGrid($db, $strCriteria, $bolLimit = true, $isFullView = false, $isExport = false)
  {
    ...
    if (isset($_POST['btnExportXLS']) || isset($_POST['btnExcelAll'])) $isExport = true;
    else $isExport = false;
    ...
    if (!$bolPrint && !$isExport){
	  $myDataGrid->addColumnCheckbox(new DataGrid_Column("chkID", "id", array('rowspan' => 2, 'width' => 30), array('align'=>'center', 'nowrap' => '')));
		...
		if(!$bolIrregular){
			...
			$myDataGrid->addColumn(new DataGrid_Column(getWords("join date"), "join_date", array("rowspan" => 2, "width" => 70),  array("nowrap" => "nowrap"), true, true, "", "formatDate()", "string", true, 12, false));
			...
			$myDataGrid->addColumn(new DataGrid_Column(getWords("grouper"), "grouper", array("rowspan" => 2, "width" => 30, "style" => "display:none"), array("style" => "display:none"), true, true, "", "", "string", true, 8, false));
			$myDataGrid->addColumn(new DataGrid_Column(getWords("currency"), "salary_currency", array("rowspan" => 2, "width" => 30),  array("align" => "center"), true, true, "", "printCurrency()", "string", true, 6, false));
		...
		if($bolIrregular){
			...
			$myDataGrid->addColumn(new DataGrid_Column(getWords("employee name"), "employee_name",array('width' => 100),  array("nowrap" => "nowrap"), true, true, "", "", "string", true, 35, false));
			...
			$myDataGrid->addColumn(new DataGrid_Column(getWords("join date"), "join_date", array( "width" => 70),  array("nowrap" => "nowrap"), true, true, "", "formatDate()", "string", true, 12, false));
			$myDataGrid->addColumn(new DataGrid_Column(getWords("sex"), "gender", array( "width" => 30),  array("align" => "center"), true, true, "", "printGender()", "string", true, 6, false));
			$myDataGrid->addColumn(new DataGrid_Column(getWords("fam."), "family_status_code", array( "width" => 30),  null, true, true, "", "", "string", true, 12, false));
			...
			$myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_code", array( "width" => 80), null, true, true, "", "getDivisionName()", "string", true, 12, false));
			$myDataGrid->addColumn(new DataGrid_Column(getWords("department"), "department_code", array( "width" => 80), null, true, true, "", "getDepartmentName()", "string", true, 12, false));
			$myDataGrid->addColumn(new DataGrid_Column(getWords("section"), "section_code", array( "width" => 80), null, true, true, "", "getSectionName()", "string", true, 12, false));
		   // $myDataGrid->addColumn(new DataGrid_Column(getWords("sub"), "sub_section_code", array("rowspan" => 2, "width" => 30), null, true, true, "", "getSubSectionName()", "string", true, 12, false));
...
//      }
	...
	$myDataGrid->addSpannedColumn(getWords("UPAH+TTP"), 3);
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("basic salary"), "alw_basic_salary", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "grade1_allowance"));
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("grade allowance"), "grade2_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "grade2_allowance"));
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("sr. allowance"), "seniority_allowance", array("width" => 90),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "seniority_allowance"));
	
	$myDataGrid->addSpannedColumn(getWords("TTTP"), 5);
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("transport allowance"), "alw_tunjangan_transport", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "alw_tunjangan_transport"));
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("att. allowance"), "alw_tunjangan_kehadiran", array("width" => 90),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "alw_tunjangan_kehadiran"));
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("family allowance"), "family_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "family_allowance"));
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("other allowance"), "alw_other_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "alw_other_allowance"));
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("shift allowance"), "shift_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "shift_allowance"));
	 $myDataGrid->addSpannedColumn(getWords("overtime"), 8);
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("ot1"), "ot1_min", array("width" => 30),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=false,decimal=2)", "numeric", true, 15));
     $myDataGrid->addColumn(new DataGrid_Column(getWords("ot2"), "ot2_min", array("width" => 30),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=false,decimal=2)", "numeric", true, 15));
     $myDataGrid->addColumn(new DataGrid_Column(getWords("ot3"), "ot3_min", array("width" => 30),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=false,decimal=2)", "numeric", true, 15));
     $myDataGrid->addColumn(new DataGrid_Column(getWords("ot4"), "ot4_min", array("width" => 30),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=false,decimal=2)", "numeric", true, 15));
     $myDataGrid->addColumn(new DataGrid_Column("Shift Hour", "shift_hour", array( "width" => 30),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "", "numeric", true, 15, false));
     $myDataGrid->addColumn(new DataGrid_Column("OT", "total_ot_min", array("width" => 30),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=false,decimal=2)", "numeric", true, 15, false));
     $myDataGrid->addColumn(new DataGrid_Column(getWords("converted"), "otx_min", array("width" => 30),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=false,decimal=2)", "numeric", true, 15));
	 $myDataGrid->addColumn(new DataGrid_Column(getWords("overtime allowance"), "overtime_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "overtime_allowance"));
	
	$myDataGrid->addSpannedColumn(getWords("deduction"), 3);
	$myDataGrid->addColumn(new DataGrid_Column(getWords("attendance deduction"), "ded_attendance_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_attendance_deduction"));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("late/early deduction"), "absence_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "absence_deduction"));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("other deduction"), "ded_other_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_other_deduction"));

	
	 if (!$bolIrregular)
    {
	$myDataGrid->addSpannedColumn(getWords("working day"), 3);
    $myDataGrid->addColumn(new DataGrid_Column(getWords("total working day"), "working_day", array("width" => 50),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "", "numeric", true, 15));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("total attendance"), "attendance_day", array("width" => 50),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "", "numeric", true, 15));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("late / early"), "l_e", array("width" => 50),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "", "numeric", true, 15));
	  }
	 
	  
	$myDataGrid->addSpannedColumn(getWords("jamsostek 5.7%"), 2);
    $myDataGrid->addColumn(new DataGrid_Column(getWords("3.7% by company"), "jamsostek_allowance", array("width" => 50),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=true,decimal=2)", "numeric", true, 15));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("2% by employee"), "jamsostek_deduction", array("width" => 50),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=true,decimal=2)", "numeric", true, 15));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("JKK 0.89% by company"), "jkk_allowance", array("rowspan" => 2,"width" => 50),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=true,decimal=2)", "numeric", true, 15));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("JK 0.3% by company"), "jkm_allowance", array("rowspan" => 2,"width" => 50),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=true,decimal=2)", "numeric", true, 15));
	
	  
/*
	
      
      $myDataGrid->addColumn(new DataGrid_Column(getWords("overtime"), "overtime_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "overtime_allowance"));
      //$myDataGrid->addColumn(new DataGrid_Column(getWords("overtime"), "overtime_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "overtime_allowance"));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("jamsostek"), "jamsostek_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15,  true, "jamsostek_allowance"));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("jkk"), "jkk_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "jkk_allowance"));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("jkm"), "jkm_allowance", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "jkm_allowance"));*/
...
/*
      ...
      //$myDataGrid->addColumn(new DataGrid_Column(getWords("loan"), "loan_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("jamsostek"), "jamsostek_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "jamsostek_deduction"));
      $myDataGrid->addColumn(new DataGrid_Column(getWords("tax"), "total_tax", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "tax_deduction"));
      foreach ($arrOtherDeduction AS $strCode => $strName) // looping data tunjangan lain-lain
      {
        $myDataGrid->addColumn(new DataGrid_Column($strName, "ded_".$strCode, array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_".$strCode));
      }
      ...
      */
      ...
      if($intLoanType > 1)
      {
        ...
        {
          $myDataGrid->addColumn(new DataGrid_Column($strName, "loan_".$strCode, array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "loan_".$strCode));
        }
      }
      else
      {
        foreach ($arrLoanType AS $strCode => $strName) // looping data tunjangan lain-lain
        {
          $myDataGrid->addColumn(new DataGrid_Column($strName, "loan_".$strCode, array("rowspan" => 2, "width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "loan_".$strCode));
        }
      }
      $myDataGrid->addColumn(new DataGrid_Column(getWords("total"), "total_gross", array("rowspan" => 2, "width" => 70),  array("align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 6, true, "total_gross"));
    ...
    if ($isExport) $strSQL .= " ORDER BY grouper, t2.employee_name";
  ...
  function printColumn($item, $key, &$myDataGrid)
  {
    ...
    {
        $myDataGrid->addColumn(new DataGrid_Column($item['name'], $item['allowance_code'], array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, $item['allowance_code']));
    }
  }
  ...
  if ($db->connect()) {
    ...
    $strCalculationMenu = "<b><a href='salary_calculation.php'>" .getWords("salary calculation list")."</a></b>";//getCalculationMenu($strDataID, 5, $intStatus);
