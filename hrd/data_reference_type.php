<?php
  ...
  {$f = new clsForm("formInput", 1, "100%", "");
    ...
    $f->addSelect(getWords("type"), "type", $arrCategory, array(), "string", true, true, true);  
    $f->addInput(getWords("reference"), "reference", "", array("size" => 50), "string", true, true, true);  
  ...
  $myDataGrid->addColumn(new DataGrid_Column(getWords("type"), "type", null, array('nowrap' => ''), true, false, "", "printCategory()"));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("reference"), "reference", array(), array('nowrap' => 'nowrap'), true, true, "", ""));
