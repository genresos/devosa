<?php
  ...
  $arrSetting = array(
    "strStartEvaluation" => array("code" => "start_evaluation", "value" => "1", "note" => "start month for evaluation periode", "default" => "1", "oldparameter" => "strStartEvaluation"),

    "strOperational" => array("code" => "weight_operational", "value" => "0", "note" => "weight for operational performance", "default" => "0", "oldparameter" => "strOperational"),
    "strGeneral" => array("code" => "weight_general", "value" => "0", "note" => "weight for employee general evaluation", "default" => "0", "oldparameter" => "strGeneral"),
    "strAbsence" => array("code" => "weight_absence", "value" => "0", "note" => "weight for employee absence", "default" => "0", "oldparameter" => "strAbsence"),

    "strLate" => array("code" => "weight_deduction_dl", "value" => "0", "note" => "datang terlambat", "default" => "0", "oldparameter" => "strLate"),
    "strEarly" => array("code" => "weight_deduction_pc", "value" => "0", "note" => "pulang cepat", "default" => "0", "oldparameter" => "strGeneral"),
    "strAlpa" => array("code" => "weight_deduction_m", "value" => "0", "note" => "alpa", "default" => "0", "oldparameter" => "strAlpa"),
  );
