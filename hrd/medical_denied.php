        ...
        if ($rowDb = $db->fetchrow($resDb)) {
          ...
          while ($rowTmp = $db->fetchrow($resTmp)) {
            ...
            if ($intTotal == 1) {
              ...
              $strResult .= "  <td align=right>" .standardFormat($rowTmp['approved_cost'],true)."&nbsp;</td>\n";
            } else {
              // tambahkan di bawah
              ...
              $strDetail .= "  <td align=right>" .standardFormat($rowTmp['approved_cost'],true)."&nbsp;</td>\n";
          ...
          if ($intTotal > 0) {
            ...
            $strResult .= "  <td align=right><strong>" .standardFormat($fltTotalCost,true)."</strong>&nbsp;</td>\n";
            $strResult .= "  <td align=right><strong>" .standardFormat($fltTotalCostApproved,true)."</strong>&nbsp;</td>\n";
