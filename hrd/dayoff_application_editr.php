<?php
  ...
  $strDataDetail = "<tr align='center' valign='middle' class='tableHeader'>  <td width='10' rowspan='2'>&nbsp;</td> <td width='10' rowspan='2'>&nbsp;</td> <td rowspan='2'>&nbsp;".$strWordsID."&nbsp;</td> <td nowrap rowspan='2'>&nbsp;" .$strWordsEmployeeName."&nbsp;</td>"./* <td colspan='2'>&nbsp;".$strWordsEarlyPlan."&nbsp; </td><td colspan='2'>&nbsp;".$strWordsEarlyAuto."&nbsp; </td>*/"<td colspan='2'>&nbsp;<strong>".$strWordsEarlyActual."</strong>&nbsp; </td><td colspan='2'>&nbsp;<strong>".$strWordsAfternoonActual."</strong>&nbsp; </td>"./*<td colspan='2'>&nbsp;".$strWordsAfternoonAuto."&nbsp; </td>*/"<td colspan='2'>&nbsp;".$strWordsAfternoonPlan."&nbsp; </td> <td colspan='2'>&nbsp;".$strWordsAttendance."</td> <td rowspan='2'>&nbsp;".$strWordsHolidayOT."&nbsp;</td> <td rowspan='2' width='30%'>&nbsp;".$strWordsTransport."&nbsp;</td> <td rowspan='2' width='30%'>&nbsp;".$strWordsTransportFee."&nbsp;</td> <td rowspan='2' width='30%'>&nbsp;".$strWordsPurpose."&nbsp;</td></tr> <tr class='tableHeader'> <td align='center' valign='middle'>".$strWordsStart."</td> <td align='center' valign='middle'>".$strWordsFinish."</td> <td align='center' valign='middle'>".$strWordsStart."</td> <td align='center' valign='middle'>".$strWordsFinish."</td>"./*<td align='center' valign='middle'><strong>".$strWordsStart."</strong></td> <td align='center' valign='middle'><strong>".$strWordsFinish."</strong></td><td align='center' valign='middle'><strong>".$strWordsStart."</strong></td> <td align='center' valign='middle'><strong>".$strWordsFinish."</strong></td>*/"<td align='center' valign='middle'>".$strWordsStart."</td> <td align='center' valign='middle'>".$strWordsFinish."</td><td align='center' valign='middle'>".$strWordsStart."</td> <td align='center' valign='middle'>".$strWordsFinish."</td></tr>";
  ...
  function getData($db, &$arrData, $strDataID = "")
  {
    ...
    if ($strDataID != "")
    {
      $arrMember = array(); // daftar anggota
      ...
      if ($rowDb = $db->fetchrow($resDb))
      {
        ...
        foreach ($arrMember AS $strIDEmployee => $arrTmp) 
        {
           ...
           //$arrData['dataDetail'] .= "  <td><input type=text name='detailStartEarlyPlan$intTotalData' id='detailStartEarlyPlan$intTotalData' value='" .substr($arrData['dataStartEarly'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></td>";

           //$arrData['dataDetail'] .= "  <td><input type='text' name='detailFinishEarlyPlan$intTotalData' id='detailFinishEarlyPlan$intTotalData' value='" .substr($arrData['dataFinishEarly'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></td>";
           ...
           //$arrData['dataDetail'] .= "  <td><strong><input type=text name='detailStartEarlyActual$intTotalData' id='detailStartEarlyActual$intTotalData' value='" .substr($arrTmp['start_early_actual'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></strong></td>";

           //$arrData['dataDetail'] .= "  <td><input type='text' name='detailFinishEarlyActual$intTotalData' id='detailFinishEarlyActual$intTotalData' value='" .substr($arrTmp['finish_early_actual'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></td>";

           $arrData['dataDetail'] .= "  <td><input type='text' name='detailStartActual$intTotalData' id='detailStartActual$intTotalData' value='" .substr($arrTmp['start_actual'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";

           $arrData['dataDetail'] .= "  <td><input type='text' name='detailFinishActual$intTotalData' id='detailFinishActual$intTotalData' value='" .substr($arrTmp['finish_actual'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";
           ...
           $arrData['dataDetail'] .= "  <td><input type='text' name='detailStartPlan$intTotalData' id='detailStartPlan$intTotalData' value='" .substr($arrData['dataStart'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";

           $arrData['dataDetail'] .= "  <td><input type='text' name='detailFinishPlan$intTotalData' id='detailFinishPlan$intTotalData' value='" .substr($arrData['dataFinish'],0,5). "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";
           

           
           $arrData['dataDetail'] .= "<input type=hidden name='detailFinishActualTemp$intTotalData' id='detailFinishActualTemp$intTotalData' size=5 maxlength=5 value='" .substr($arrTmp['finish_actual'],0,5). "' class='time' disabled>";
           ...
           $arrData['dataDetail'] .= "  <td><input type=text name='detailAttendanceStart$intTotalData' id='detailAttendanceStart$intTotalData' value='" .substr($arrTmp['attendance_start'],0,5). "' size=5 readonly></td>";
           $arrData['dataDetail'] .= "  <td><input type=text name='detailAttendanceFinish$intTotalData' id='detailAttendanceFinish$intTotalData' value='" .substr($arrTmp['attendance_finish'],0,5). "' size=5 readonly></td>";
  ...
  function saveData($db, &$strDataID, &$strError)
  {
    ...
    $strDataDueDate  = (isset($_REQUEST['dataDueDate']))? $_REQUEST['dataDueDate'] : $strTodays ;
    ...
    if ($strDataDueDate == "") {
      $strDataDueDate = $strToday;
    }

    // cek validasi -----------------------
    if ($strDataDate == "" || $strDataEntryDate == "" || $strDataDueDate == "" ) {
    ...
    if ($strDataID == "")
    {
      $strTmpID = $db->getNextID("hrd_dayoff_application_id_seq");
      // data baru
      ...
      $strSQL .= "'" .$_SESSION['sessionUserID']. "', '$strDataDate', '$strDataEntryDate', '$strDataDueDate',";
      $strSQL .= "'$strDataNote', ";
    ...
    else
    {
      ...
      $strSQL .= "do_date = '$strDataDate', entry_date = '$strDataEntryDate', due_date = '$strDataDueDate', ";
    ...
    for ($i = 1; $i <= $intTotal; $i++)
    {
      ...
      if ($strIDEmployee == "") continue;
      if (isDataExists("hrd_dayoff_application_employee","id_employee", $strIDEmployee, "AND do_date = '$strDataDate'")) continue;
      ...
      else
      {
         ...
         if ($strStartEarlyActual  == "null" || $strFinishEarlyActual  == "null")
            ...
            $intDurationEarly = getIntervalHour($_REQUEST['detailStartEarlyActual'.$i], $_REQUEST['detailFinishEarlyActual'.$i]);
      }
	  */
      ...
      $strTransportFee  = (isset($_REQUEST['detailTransportFee'.$i]) && is_numeric($_REQUEST['detailTransportFee'.$i])) ? $_REQUEST['detailTransportFee'.$i] : 0;
      ...
      if ($strStartActual == "null" || $strFinishActual == "null")
         $arrOT = array("l1" => 0, "l2" => 0, "l3" => 0, "l4" => 0, "total" => 0);
      else
         $arrOT = calculateOvertimeByOTSchedule($db, $strDataDate, $_REQUEST['detailStartActual'.$i], $_REQUEST['detailFinishActual'.$i], $intDurationEarly, $bolHoliday, $intBreakType, true,  $intBreakFlag, $intBreakLinkID);
      ...
      if ($strIDEmployee != "")
      {
         ...
         $strSQL .= "do_date, entry_date, transport, transport_fee) ";
         ...
         $strSQL .= "'$strDataDate', '$strDataEntryDate','$strTransport', $strTransportFee); ";
/*
    ...
    if ($strDataID == "")
    {
      ...
      $resDb = $db->execute($strSQL);
      if ($rowDb = $db->fetchrow($resDb)) $strDataID = $rowDb['max_id'];
    }
    return true;
  } // saveData
  ...
  function addEmployee($db, $strList, $strOldList, $strDate, $intTotalData)
  {
    ...
    if ($strList == "") return "$intTotalData~$strOldList~";
    ...
    foreach($arrEmp as $strID => $arrData)
    {
       ...
       {
          $intTotalData++;
          $strNormalStart     = (isset($arrData['normal_start']))      ? substr($arrData['normal_start'],0,5)      : $strNormalStart;
          $strNormalFinish    = (isset($arrData['normal_finish']))     ? substr($arrData['normal_finish'],0,5)     : $strNormalFinish;
          ...
          $strResult .= /*$strStartEarlyTimeAuto*/" >";     //8
          $strResult .= /*$strFinishTimeAuto*/" >";        //9
  ...
  function getDataBreak($db, $tipe, $strDataID)
  {
    ...
    while ($rowDb = $db->fetchrow($resDb))
    {
      ...
      $strResult .= "  <td><input type=hidden name=dataID$tipe"."_$i value=".$rowDb['id']."><input type=text name=dataBreak$tipe"."_$i size=12 maxlength=10 value=" .substr($rowDb['start_time'],0,5). "></td>\n";
  ...
  if ($db->connect())
  {
    ...
    {
        echo addEmployee($db, $_REQUEST['strList'], $_REQUEST['strOldList'], $_REQUEST['strDate'], $_REQUEST['intTotalData']);
        exit();
    }
    ...
    scopeData($arrUserInfo['employee_id'], $strDataSubSection, $strDataSection, $strDataDepartment, $strDataDivision, $_SESSION['sessionUserRole'], $arrUserInfo);
    ...
    if($bolSave)
    {
      ...
      else echo "<script>alert(\"Sorry, you are not authorized to modify data in this page\")</script>";
    ...
    $strInputEmployee .= " <input type=button name=btnAdd value='" .getWords("add to list"). "'  onClick='addEmployee(document.formInput.dataEmployee.value)' >";
    ...
    $strInputDueDate  = "<input type=text name=dataDueDate id=dataDueDate size=12 maxlength=10   value=\"" .$arrData['dataEntryDueDate']. "\" readonly>";
    ...
    $strInputDivision = getDivisionList($db,"dataDivision", $strDataDivision, $strEmptyOption,""," style=\"width:150px\" onChange=\"searchEmployee()\" ". $ARRAY_DISABLE_GROUP['division']);
    $strInputDepartment = getDepartmentList($db,"dataDepartment", $strDataDepartment, $strEmptyOption,""," style=\"width:150px\" onChange=\"searchEmployee()\" ". $ARRAY_DISABLE_GROUP['department']);
    $strInputSection = getSectionList($db,"dataSection", $strDataSection, $strEmptyOption,""," style=\"width:150px\" onChange=\"searchEmployee()\" ". $ARRAY_DISABLE_GROUP['section']);
    $strInputSubSection = getSubSectionList($db,"dataSubSection", $strDataSubSection, $strEmptyOption,""," style=\"width:150px\" onChange=\"searchEmployee()\"". $ARRAY_DISABLE_GROUP['sub_section']);
