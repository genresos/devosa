<?php
  ...
  function getDataListPosition($default = null, $isHasEmpty = false, $emptyData = null)
  {
    ...
    $arrData = $tbl->generateList(null, "position_code", null, "position_code", array("position_code", "position_name"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  function getDataListSalaryGrade($default = null, $isHasEmpty = false, $emptyData = null)
  {
    ...
    $arrData = $tbl->generateList(null, "grade_code", null, "grade_code", array("grade_code"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  function getDataEmployee($default = null, $isHasEmpty = false, $emptyData = null)
  {
    ...
    $arrData = $tbl->generateList("active = 1 ".$strKriteriaCompany, "employee_id", null, "employee_id", array("employee_name"));
    if ($default != null || $default != "")
    {
      while(list($key, $val) = each($arrData))
      {
  ...
  function getDataList($data, $indexed = true, $default = null, $isHasEmpty = false, $emptyData = null)
  {
    ...
    if ($default == null && $isHasEmpty) $arrData[1]['selected'] = true;
  ...
  function getDataListTrainingType($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList($criteria, "id", null, "id", array("code", "name"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  function getDataListMRF($default = null, $isHasEmpty = false, $emptyData = null, $bolAll = false, $includeID = "")
  {
    ...
    $arrData = $tbl->generateList($strKriteria, "position_code", null, "id", array("request_number", "position_code", "department_code"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  */
  ...
  function getDataListCategoryItem($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("category_name"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  function getDataListRoom($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("room_name"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  function getDataListItem($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("item_name"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  function getDataListVendor($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("vendor_name"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  function getDataLisApartmentRequest($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("apartment_req_no"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
...
;  }
  ...
  function getDataLisVehicleRequest($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("vehicle_req_no"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
...
;  }
  ...
  {
    {
      ...
      while ($rowDb = $db->fetchrow($res)){
	  	if ($default==$rowDb['id']){
		  $result[] = array("value"=>$rowDb['id'], "text"=>$rowDb['item_name'], "selected" =>true);	
		}else{
		  $result[] = array("value"=>$rowDb['id'], "text"=>$rowDb['item_name'], "selected" =>false);	
		} 
      }
    }
    return $result;
  ...
  function getDataListDriver($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("driver_name"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
  ...
  {
  	$arrMonth = array(1 => "Document", "Vehicle", "Consumable", "Common Asset");
    $arrData = array();
    foreach($arrMonth as $key => $val)
    {
       $arrData[] = array("value" => $val, "text" => $val, "selected" => true);
    }
	return $arrData;	    
  }  
  //=============================== END =========================================================
  ...
  */
  ...
  function getDataListConsumableRequestNo($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("consumable_req_no"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
...
;  }
  ...
  function getDataListPurchaseNo($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("purchase_no"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
...
;  }
	...
	function getDataRequestOrder($default = null, $isHasEmpty = false, $emptyData = null, $criteria = "")
  {
    ...
    $arrData = $tbl->generateList("1=1 ". $criteria, "id", null, "id", array("request_order_no"), $isHasEmpty, $emptyData);
    if ($default != null || $default != "")
      while(list($key, $val) = each($arrData))
      {
        $temp = &$arrData[$key];
