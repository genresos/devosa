<?
    ...
    $strResult = "
      <table cellspacing=0 class='gridTable'>
        <tr class='tableHeader'>
          <td class='tableHeader' rowspan=2>No.</td>
          <td class='tableHeader' rowspan=2 nowrap>Employee ID.</td>
          <td class='tableHeader' colspan=2 rowspan=2 nowrap>Name</td>
          <td class='tableHeader' colspan=$intMax align=center>Date</td>
        </tr>
        <tr class='tableHeader'>
          $strResultT
        </tr>
  ...
  if ($db->connect()) {
    ...
    /*if ($bolCanView && $_SESSION['sessionUserRole'] >= ROLE_SUPERVISOR)
    {
