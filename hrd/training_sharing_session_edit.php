<?php
  ...
  $dataPrivilege = getDataPrivileges("training_sharing_session_list.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove);
 ...
 //---- INISIALISASI ----------------------------------------------------
  ...
  function getTrainingTrainer($db) 
  {
    ...
    if ($arrData['dataTrainingID'] == "")
    { // tanpa training, jadi ID karyawan bisa diisikan
      ...
      $strResult .= "  <td colspan=3>&nbsp;<a href=\"javascript:showMoreInput(0);\">" .getWords('more'). "</a></td></tr>\n";      
    }
  ...
  function getTrainingParticipant($db, $strDataID = "") 
  {
    ...
    $strResult .= " <tr valign=top><td>&nbsp;</td>\n";
    $strResult .= "  <td colspan=4>&nbsp;<a href=\"javascript:showMoreInput(1);\">" .getWords('more'). "</a></td></tr>\n";
    $strResult .= "  </table>\n";
  ...
  if ($db->connect()) 
  {
    ...
    if ($arrUserInfo['department_code'] != "" && $_SESSION['sessionUserRole'] == ROLE_EMPLOYEE) $strPlanKriteria .= "AND department_code = '" .$arrUserInfo['department_code']."' ";
    ...
    $arrData['dataTrainingPlace'] = (isset($arrTmp[$arrData['dataTrainingPlace']])) ? getWords($arrTmp[$arrData['dataTrainingPlace']]) : "";
