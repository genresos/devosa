<?php
  ...
  // GENERATE CRITERIA
    ...
    $resDb = $db->execute($strSQL);
    while ($rowDb = $db->fetchrow($resDb)) {
        $arrQuota2[$rowDb['id_employee']][$rowDb['id_medical_type']] = array("amount" => $rowDb['amount'], "claimed" => $rowDb['claimed']) ;
    }
  ...
  function saveData() 
  {
    ...
    $codeBasicSalary=array('branch1_allowance','branch2_allowance',
        'branch3_allowance','grade1_allowance','grade2_allowance','grade3_allowance','position1_allowance',
        'position2_allowance','position3_allowance','family_status1_allowance','family_status2_allowance',
        'family_status3_allowance','functional1_allowance','functional2_allowance','functional3_allowance');
...
$jx1=0;
$jx2=0;
$strSettingSalaryCode_active = array();
$strSettingSalaryValue_active = array();
$strSettingSalaryCode_benefit = array();
$strSettingSalaryValue_benefit = array();
