<?php
  ...
  */
  ...
  {
    var $strAttendanceDate; // tanggal kehadiran, format YYYY-MM-DD
    var $db; // kelas database, sudah terkoneksi

    // atribut sebagai filter, jika ada
    var $strEmployeeID; // nik, sebagai filter
    var $strDivisionCode;
    var $strDepartmentCode;
    var $strSectionCode;
    var $strSubSectionCode;
    var $strGroup;
    var $strCompany;
    ...
    var $arrCompany;     // daftar branch, terkait dengan data kehadiran (berupa text, bisa lebih dari satu)
    ...
    var $arrGroup;       // daftar grup, terkait dengan data kehadiran
    ...
    var $objAttendance;   // untuk menyimpan data kehadiran karyawan tertentu di tanggal tersebut
    ...
    */
    ...
    {
      $this->arrOutOffice = getOutOfficeInfo($this->db, $this->strAttendanceDate, $this->strAttendanceDate); // activity.php
    }
    ...
    */
    function isPublicHoliday()
    {
      ...
      {
        if ($rowDb['holiday'] != "") $this->bolPublicHoliday = true;
      }
    }
    ...
    */
    ...
    {
      return ((isset($this->arrAttendance[$strID])) ? $this->arrAttendance[$strID] : array());
    }
    ...
    function initAttendanceInfo()
    {
      if ((isset($this->arrEmployee[$this->objAttendance->strIDEmployee])))
      {
        ...
        if ($this->arrEmployee[$this->objAttendance->strIDEmployee]['is_overtime'] == 't')
          $this->objAttendance->bolGetOT = true; // dapat OT
      }
      else
      {
        $strTmpSection    = "";
...
*/
  ...
  */
  class clsAttendanceInfo
  {
    ...
    var $strShiftCode2;    // kode shift, jika ada -- untuk menentukan kerja siang atau malam
