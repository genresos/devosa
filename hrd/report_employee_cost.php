<?
  ...
  function getData($db, $strDateFrom, $strDateThru, &$intRows, $strKriteria = "", $intPage = 1, $bolLimit = true, $strOrder = "") {
    global $words;
    global $bolPrint;
  ...
  function getDataExcel($db, $strDateFrom, $strDateThru, &$intRows, $strKriteria = "", $intPage = 1, $bolLimit = true, $strOrder = "") {
    ...
    $col = 0;
    $arrHeader[$col++] = array("text" => strtoupper(getWords("no")), "type" => "numeric", "width" => 5);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("employee id")), "type" => "", "width" => 12);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("employee name")), "type" => "", "width" => 17);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("department")), "type" => "", "width" => 8);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("section")), "type" => "", "width" => 8);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("functional")), "type" => "", "width" => 8);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("salary")), "type" => "numeric", "width" => 10);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("conjuncture")), "type" => "numeric", "width" => 10);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("tiras")), "type" => "numeric", "width" => 10);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("medical")), "type" => "numeric", "width" => 10);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("ot claim")), "type" => "numeric", "width" => 10);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("business trip")), "type" => "numeric", "width" => 10);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("training")), "type" => "numeric", "width" => 10);
    $arrHeader[$col++] = array("text" => strtoupper(getWords("total")), "type" => "numeric", "width" => 10);
  ...
  if ($db->connect()) {
    ...
    if ($bolCanView) {
      if (isset($_REQUEST['btnExcel'])) {
        $strDataDetail = getDataExcel($db,$arrPeriode['date_from'], $arrPeriode['date_thru'], $intTotalData, $strKriteria, $intCurrPage, $bolLimit);
      } else {
        $strDataDetail = getData($db,$arrPeriode['date_from'], $arrPeriode['date_thru'], $intTotalData, $strKriteria, $intCurrPage, $bolLimit);
      }
