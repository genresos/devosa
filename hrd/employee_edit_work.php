<?php
  ...
  function getData($db, &$intRows, $strKriteria = "", $strOrder = "") {
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
      ...
      $strResult .= "<tr valign=top>\n";
      $strResult .= "  <td nowrap>&nbsp;" .$words['position']."</td>";
      $strResult .= "  <td nowrap>:&nbsp;</td>";
      $strResult .= "  <td>&nbsp;<input type=text size=$intDefaultWidth maxlength=31 name=detailPosition$intRows value=\"" .$rowDb['position']. "\" style=\"width:$intDefaultWidthPx\"></td>";
      $strResult .= "</tr>\n";
    ...
    for ($i = 1; $i <= $intAdd; $i++) {
      ...
      $strResult .= "  <td nowrap>&nbsp;" .$words['position']."</td>";
      $strResult .= "  <td nowrap>:&nbsp;</td>";
      $strResult .= "  <td>&nbsp;<input type=text size=$intDefaultWidth maxlength=50 name=detailPosition$intRows $strDisabled style=\"width:$intDefaultWidthPx\"></td>";
      $strResult .= "</tr>\n";
