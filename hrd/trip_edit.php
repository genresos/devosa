<?php
  ...
  //  $dataTrip = $tblTrip->find("
    $strReadonly = (scopeGeneralDataEntry($arrData['dataEmployee'], $_SESSION['sessionUserRole'], $arrUserInfo, $isNew)) ? "readonly" : "";
  ...
  // ------------------------------------------------------------------------------------------------------------------------------
    ...
    if ($bolCanEdit)
    {
      ...
      if (($strDataTripTypeID != "" || $strDataDateFrom == "" )&& $total>0)
      { 
