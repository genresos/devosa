<?php
  ...
  $dataPrivilege = getDataPrivileges(basename("attendance_edit_by_employee.php"), $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanCheck, $bolCanAcknowledge, $bolCanApprove2);
  ...
  function getData($db, $strDataDate, &$intRows, $strKriteria = "", $strOptionShow = "",$intPage = 1, $bolLimit = true, $strOrder = "") {
    global $words;
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
      ...
      */
      ...
      $strOTClass = "";
      if ($strDataIsOvertime != "") $strOTClass = "class=\"bgHoliday\"";
