...
//     $strResult = "";
    ...
    if (!is_numeric($fltWeightOperational)) $fltWeightOperational = 0;
    if (!is_numeric($fltWeightAbsence)) $fltWeightAbsence = 0;
    if (!is_numeric($fltWeightGeneral)) $fltWeightGeneral = 0;
...
*/
  ...
  function showDataDepartment($db, $arrData) {
    ...
    $arrEmptyData = array(
      "id" => "", "operational" => 0, "absence" => 0, "general" => 0, "result" => 0,
...
//     $strResult .= "<table cellspacing=0 cellpadding=1 border=0 class=gridTable>\n";
  ...
  if ($db->connect()) {
    ...
    if (isset($_REQUEST['filterYear'])) $strFilterYear = $_REQUEST['filterYear'];
    if (isset($_REQUEST['filterDepartment'])) $strFilterDepartment = $_REQUEST['filterDepartment'];
    if (isset($_REQUEST['filterSemester'])) $strFilterSemester = $_REQUEST['filterSemester'];
