<?php
  ...
  $intDefaultWidth = 35;
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
      ...
      $strResult .= "  <input type=text size=$intDefaultWidth maxlength=127 name=detailName$intRows value=\"" .$rowDb['name']. "\"></td>";
	...
	$strResult .= "  <td nowrap>" .getGenderList("detailGender$intRows",$rowDb['gender']). "</td>";
      ...
      $strResult .= "  <td nowrap><input type=text size=15 maxlength=10 name=detailBirthday$intRows id=\"detailBirthday$intRows\" value=\"" .$rowDb['birthday']. "\">&nbsp;";
      $strResult .= "<input type=button id=\"target_$intRows\" value='..'></td>";
      $strResult .= "  <td nowrap align=right>" .$rowDb['umur']. "&nbsp;</td>";
      $strResult .= "  <td nowrap>" .getEducationList($db,"detailEducation$intRows",$rowDb['education_code'], $strEmptyOption,""). "</td>";
      $strResult .= "  <td nowrap><input type=text size=$intDefaultWidth maxlength=31 name=detailJob$intRows value=\"" .$rowDb['job']. "\"></td>";
      $strResult .= "  <td nowrap><input type=text size=$intDefaultWidth maxlength=127 name=detailCompany$intRows value=\"" .$rowDb['company']. "\"></td>";
      $strResult .= "  <td nowrap><input type=text size=$intDefaultWidth maxlength=31 name=detailPosition$intRows value=\"" .$rowDb['position']. "\"></td>";
      $strResult .= "  <td nowrap><input type=text size=75 maxlength=255 name=detailNote$intRows value=\"" .$rowDb['note']. "\"></td>";
    ...
    for ($i = 1; $i <= $intAdd; $i++) {
      ...
      $strResult .= "  <td nowrap><input type=text size=$intDefaultWidth maxlength=50 name=detailName$intRows $strDisabled></td>";
      ...
      $strResult .= "  <td nowrap><input type=text size=15 maxlength=10 name=detailBirthday$intRows id=\"detailBirthday$intRows\" value=$strNow>&nbsp;";
      $strResult .= "<input type=button id=\"target_$intRows\" value='..'></td>";
      $strResult .= "  <td nowrap>&nbsp;</td>";
      $strResult .= "  <td nowrap>" .getEducationList($db,"detailEducation$intRows","", $strEmptyOption,""). "</td>";
      $strResult .= "  <td nowrap><input type=text size=$intDefaultWidth maxlength=50 name=detailJob$intRows></td>";
      $strResult .= "  <td nowrap><input type=text size=$intDefaultWidth maxlength=50 name=detailCompany$intRows></td>";
      $strResult .= "  <td nowrap><input type=text size=$intDefaultWidth maxlength=50 name=detailPosition$intRows></td>";
      $strResult .= "  <td nowrap><input type=text size=75 maxlength=50 name=detailNote$intRows  $strDisabled></td>";
      $strAction = " onChange = \"chkDeleteChanged($intRows);\" ";
      $strResult .= "  <td align=center><input type=checkbox name='chkID$intRows' value=\"" .$rowDb['id']. "\" $strAction></td>\n";
      $strResult .= "</tr>\n";
