<?php
  ...
  $dataPrivilege = getDataPrivileges("working_calendar.php", $bolCanView, $bolCanEdit, $bolCanDelete, $bolCanApprove, $bolCanCheck, $bolCanAcknowledge, $bolCanApprove2);
  ...
  $myDataGrid->addColumn(new DataGrid_Column(getWords("event"), "holiday", array('width' => '150'),array('nowrap' => '')));
  ...
  $myDataGrid->addColumn(new DataGrid_Column(getWords("category"), "category", array('width' => '60'), array('align' => 'center', 'nowrap' => ''), true, true, "","printEventCategory()"));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("holiday"), "status", array('width' => '60'), array('align' => 'center', 'nowrap' => ''), true, false, "","printIsHoliday()"));
  $myDataGrid->addColumn(new DataGrid_Column(getWords("leave"), "leave", array('width' => '60'), array('align' => 'center', 'nowrap' => ''), true, false, "","printIsLeave()"));
  

  $myDataGrid->addButtonExportExcel("Export Excel", "event_list_".$strDataYear.".xls", getWords("event list")." ".$strDataYear);
