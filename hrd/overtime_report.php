<?php
  ...
  function getData($db, $strDataDateFrom, $strDataDateThru, &$intRows, $strKriteria = "", $strOrder = "")
  {
    ...
    if (!is_numeric($fltHourPerMonth)) $fltHourPerMonth = 0;
...
/*
    ...
    $strResult .= "  <td nowrap>&nbsp;" .strtoupper(getwords("n i k"))."</td>\n";
...
*/
  ...
  function showRows($strNo, $arrData, $strClass = "", $intType = 0)
  {
    ...
    if ($bolDataCost) {
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['basic_salary'],true,2)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['ot1']/60,true)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['amount1'],true,0)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['ot2']/60,true)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['amount2'],true,0)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['ot3']/60,true)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['amount3'],true,0)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['ot4']/60,true)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth>" .cekStandardFormat($arrData['amount4'],true,0)."</td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth><strong>" .cekStandardFormat($arrData['total']/60,true)."</strong></td>\n";
      $strResult .= "  <td nowrap align=right $strDefaultWidth><strong>" .cekStandardFormat($arrData['amountTotal'],true,0)."</strong></td>\n";
    } else {
      ...
      $strResult .= "  <td nowrap align=right><strong>" .cekStandardFormat($arrData['total']/60,true)."</strong></td>\n";
    }
  ...
  function showDataDepartment($db, $arrData, &$intRows) {
    ...
    $arrEmptyData = array(
      "id" => "", "ot1" => 0, "ot2" => 0, "ot3" => 0, "ot4" => 0, "total" => 0,
      "amount1" => 0, "amount2" => 0, "amount3" => 0, "amount4" => 0, "amountTotal" => 0,
      "employee_id" => "", "employee_name" => "", "basicSalary" => 0,
    );
...
//         $strDataDetail = showData($arrDataDetail);
    ...
    $strInputSection = getSectionList($db,"dataSection",$strDataSection, $strEmptyOption, $strTmpKriteria, "style=\"width:$intDefaultWidthPx\" $strDisabled");
    ...
    $arrTmp = array("", "employee", "outsource");
