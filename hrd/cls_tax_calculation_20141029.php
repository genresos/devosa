<?php
  ...
  */
  ...
  {    
    ...
    var $fltMaxPosition = 500000; // maximum tunj. jabatan  - konstanta
    var $strIDEmployee  ="";
    ...
    */
    ...
    function setDataIncludeIrregular($fltPKP, $fltPIKP, $strFamilyStatus, $bolNPWP = false, $intPeriod = 12, $fltJamsostekDeduction, $strIDEmployee, $strEmployeeStatus, $arrEmpBaseTaxPaidTaxBefore = null, $calcMonth = 1)
    {
      $this->fltPKP                   = (is_numeric($fltPKP)) ? $fltPKP : 0;
    ...
    */
    function getTax()
    {
      if ($this->intMethod == 1) // gross up
        return $this->calculatePph21GrossUp($this->fltPKP, $this->bolNPWP, $this->intPeriod, $this->fltJamsostekDeduction);
      else // gross
        return $this->calculatePph21Gross($this->fltPKP, $this->bolNPWP, $this->intPeriod, $this->fltJamsostekDeduction);
    }
    ...
    */
    function getIrregularTax()
    {
      ...
      if ($this->intMethod == 1) // gross up
        return $this->calculateIrregularPph21GrossUp($this->fltPKP, $this->fltPIKP, $this->fltPTKP, $this->bolNPWP, $this->intPeriod, $this->fltJamsostekDeduction, $this->strIDEmployee);
      else // gross
      {
         $fltRegIrr = $this->calculateIrregularPph21Gross($this->fltPKP, $this->fltPIKP, $this->fltPTKP, $this->bolNPWP, $this->intPeriod, $this->fltJamsostekDeduction, $this->strIDEmployee);
...
//                }
    ...
    /* calculateIrregularPph21Gross : fungsi untuk menghitung/mengirimkan pajak Pph21, dengan metode gross, include pendapatan irregular
        ...
        output : pajak
    */
    function calculateIrregularPph21Gross($fltBasic, $fltPIKP, $fltPTKP, $bolNPWP, $intMonth = 12, $fltJamsostekDeduction, $strIDEmployee) 
    {
      $countpph21 = new countPPH21($intMonth, $this->arrPTKP);
      $arrSalaryLimit2008 = array( 25000000, 50000000, 100000000, 200000000, 200000000); // versi tahun 2008 ke bawah
      $arrTaxRate2008     = array( 0.05, 0.10, 0.15, 0.25, 0.35); // versi tahun 2008 ke bawah
      $arrSalaryLimit     = array( 50000000, 250000000, 500000000, 50000000000); // versi 2009, yang punya NPWP
      $arrTaxRate         = array( 0.05, 0.15, 0.25, 0.30); // versi 2009 yang punya NPWP
      //$arrSalaryLimitNo   = array( 0, 50000000, 250000000, 500000000); // versi 2009 tanpa NPWP
      $arrTaxRateNo       = array( 0.06, 0.18, 0.30, 0.36); // versi 2009 tanpa NPWP
    ...
    /* calculateIrregularPph21Gross : fungsi untuk menghitung/mengirimkan pajak Pph21, dengan metode gross, include pendapatan irregular
        ...
        output : pajak
    */
    function calculateIrregularPph21GrossUp($fltBasic, $fltPIKP, $fltPTKP, $bolNPWP, $intMonth = 12, $fltJamsostekDeduction, $strIDEmployee) 
    {
      $countpph21 = new countPPH21($intMonth, $this->arrPTKP);
      $arrSalaryLimit2008 = array( 25000000, 50000000, 100000000, 200000000, 200000000); // versi tahun 2008 ke bawah
      $arrTaxRate2008     = array( 0.05, 0.10, 0.15, 0.25, 0.35); // versi tahun 2008 ke bawah
      $arrSalaryLimit     = array( 0, 50000000, 250000000, 500000000, 50000000000); // versi 2009, yang punya NPWP
      $arrTaxRate         = array( 0.05, 0.15, 0.25, 0.30); // versi 2009 yang punya NPWP
      //$arrSalaryLimitNo   = array( 0, 50000000, 250000000, 500000000); // versi 2009 tanpa NPWP
      $arrTaxRateNo       = array( 0.06, 0.18, 0.30, 0.36); // versi 2009 tanpa NPWP
