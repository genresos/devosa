...
// getDataPrivileges ada di '../global.php'
  ...
  $f->addSubmit("btnPrint", getWords("print report"), array(""), true, true, "", "", "showReport");
  $f->addSubmit("btnExcel", getWords("export excel"), array(""), true, true, "", "", "showReport");
  ...
  function showData()
  {
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("employe name"), "employee_name", array('width' => 100), array('nowrap' => 'nowrap'), false, false, "", "", "string", true, 12, false));//, strtoupper(getWords("rekapitulation")), true));
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("level"), "position_code", array('width' => 120), array('align' => 'center'), false, false, "", "", "string", true, 16, false));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("band"), "grade_code", array('width' => 120), array('align' => 'center'), false, false, "", "", "string", true, 16, false));
    $myDataGrid->addColumn(new DataGrid_Column(strtoupper(getWords("PT")), "code", array('width' => 50), array("align" => "center"), false, false, "", "", "string", true, 8, false));
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("date start"), "join_date", array('width' => 100), array('align' => 'center'), false, false, "", "", "string", true, 12, false));
    ...
    */
    ...
    $strSQL = " select 
      ...
      from (
        ...
        where position_new_date BETWEEN '".$f->getValue('data_date_from')."' AND '".$f->getValue('data_date_thru')."' 
      ) as he
	    inner join (
