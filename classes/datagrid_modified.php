  ...
  class cDataGridNew extends cDataGrid 
  {
    ...
    function printOpeningRow($intRows, $rowDb)
    {
      ...
      if (isset($rowDb['status'])) 
      {
        ...
        {
          if ($strStatus == strtolower(getWords("new"))) $strStatus = 0;
          else if ($strStatus == strtolower(getWords("verified"))) $strStatus = 1;
          else if ($strStatus == strtolower(getWords("checked"))) $strStatus = 2;
          else if ($strStatus == strtolower(getWords("approved"))) $strStatus = 3;
          else if ($strStatus == strtolower(getWords("denied"))) $strStatus = 4;
        }
