<?php
  ...
  function getData($db)
  {
    ...
    $strInputNewOT = "<input type=checkbox name=dataNewOT $strChecked>";

    $strChecked = ($result['new_absence'] == 't') ? 'checked' : '' ;
    $strInputNewAbsence = "<input type=checkbox name=dataNewAbsence $strChecked>";

    $strChecked = ($result['new_employee'] == 't') ? 'checked' : '' ;
    $strInputNewEmployee = "<input type=checkbox name=dataNewEmployee $strChecked>";

    $strChecked = ($result['new_recruitment'] == 't') ? 'checked' : '' ;
    $strInputNewRecruitment = "<input type=checkbox name=dataNewRecruitment $strChecked>";

    $strChecked = ($result['check_ot'] == 't') ? 'checked' : '' ;
    $strInputCheckOT = "<input type=checkbox name=dataCheckOT $strChecked>";

    $strChecked = ($result['check_absence'] == 't') ? 'checked' : '' ;
    $strInputCheckAbsence = "<input type=checkbox name=dataCheckAbsence $strChecked>";

    $strChecked = ($result['check_employee'] == 't') ? 'checked' : '' ;
    $strInputCheckEmployee = "<input type=checkbox name=dataCheckEmployee $strChecked>";

    $strChecked = ($result['check_recruitment'] == 't') ? 'checked' : '' ;
    $strInputCheckRecruitment = "<input type=checkbox name=dataCheckRecruitment $strChecked>";

    $strChecked = ($result['approve_ot'] == 't') ? 'checked' : '' ;
    $strInputApproveOT = "<input type=checkbox name=dataApproveOT $strChecked>";

    $strChecked = ($result['approve_absence'] == 't') ? 'checked' : '' ;
    $strInputApproveAbsence = "<input type=checkbox name=dataApproveAbsence $strChecked>";

    $strChecked = ($result['approve_employee'] == 't') ? 'checked' : '' ;
    $strInputApproveEmployee = "<input type=checkbox name=dataApproveEmployee $strChecked>";

    $strChecked = ($result['approve_recruitment'] == 't') ? 'checked' : '' ;
    $strInputApproveRecruitment = "<input type=checkbox name=dataApproveRecruitment $strChecked>";
