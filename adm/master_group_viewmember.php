  ...
  if ($db->connect()) 
  {
      ...
      if ($db->numrows() > 0) 
      {
        ...
        while ($rowDb = $db->fetchrow()) {
          ...
          if ($rowDb['active']=='t')
            $strData .= "    <td width=\"89\" nowrap align=\"center\">&nbsp;<font class=\"active\">".getWords("active")."</font></td>\n";
          else
            $strData .= "    <td width=\"89\" nowrap align=\"center\">&nbsp;<font class=\"inactive\">".getWords("inactive")."</font></td>\n";
          $strData .= "  </tr>\n";
        }
        $strData .= "</table>\n";
      } else {
