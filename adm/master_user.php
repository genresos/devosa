<?php
  ...
  if ($db->connect())
  {
    ...
    if ($bolCanEdit)
    {
      ...
      //$f->addInput(getwords("n i k"), "dataEmployee", "", array("size" => 10), "string", false, true, true, "", "&nbsp;(".getWords("if any").")");
      $f->addInputAutoComplete(getwords("n i k"), "dataEmployee", getDataEmployee(), array("size" => 50), "string", false);
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getwords("n i k"), "employee_id", array('width' => '110'), array('align'=>'center','nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("company access right"), "company_name", array('width' => '250'), array('align'=>'center','nowrap' => '')));
    ...
    $strSQL = "SELECT * FROM ($strSQL) AS mst_user WHERE 1=1 ";
...
//--------------------------------------------------------------------------------
  ...
  function getDataGroup()
  {
    ...
    if ($db->connect())
    {
      $strSQL  = "SELECT * FROM adm_group WHERE active='t' ORDER BY name";
