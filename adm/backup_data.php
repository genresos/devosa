<?php
  ...
  if ($db->connect()) {
    ...
    if (!$bolCanView) {
      ...
      $strRestoreButton = "<input type=submit name='btnRestore' value=\"" .getWords("restore data")."\" onClick=\"return confirmRestore();\">";
    }
  }
