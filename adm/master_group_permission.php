<?php
  ...
  if ($strDataID == "") header("location:master_group.php");
  ...
  if ($db->connect())
   {
    if (isset($_POST['btnCancel'])) header("location:master_group.php");
...
//--------------------------------------------------------------------------------
  ...
  function getMenu($db, $strDataID)
  {
    ...
    $strSQL .= "a.menu_level, a.php_file, b.name AS modulename, g.view, g.edit, g.delete, g.check, g.approve, g.approve2, g.id_adm_group AS idgroup ";
    ...
    if ($db->connect())
    {
      ...
      while ($rowDb = $db->fetchrow($res))
      {
        ...
        $rowDb['approve2checked'] = ($rowDb['approve2'] == 't' && $rowDb['menu_level'] != 0) ? "checked" : "";
        if ($rowDb['php_file'] == null) $rowDb['php_file'] = '';
  ...
  function getMenuPrivileges($db, $strDataID)
  {
    ...
    foreach ($arrMenu as $rowDb)
    {
      if ($lastModule != $rowDb['modulename'])
      {
        ...
        $strResult .= "  <td align=\"center\"><input name=\"chkIDview_".$rowDb['id_adm_module']."\" id=\"chkIDview_".$rowDb['id_adm_module']."\" type=\"checkbox\" value='noSave' onClick=\"checkClick(this);\" [chkIDViewModule_".$rowDb['id_adm_module']."]></td>";
        $strResult .= "  <td align=\"center\"><input name=\"chkIDedit_".$rowDb['id_adm_module']."\" id=\"chkIDedit_".$rowDb['id_adm_module']."\" type=\"checkbox\" value='noSave' onClick=\"checkClick(this);\" [chkIDEditModule_".$rowDb['id_adm_module']."]></td>";
        $strResult .= "  <td align=\"center\"><input name=\"chkIDdelete_".$rowDb['id_adm_module']."\" id=\"chkIDdelete_".$rowDb['id_adm_module']."\" type=\"checkbox\" value='noSave' onClick=\"checkClick(this);\" [chkIDDeleteModule_".$rowDb['id_adm_module']."]></td>";
        $strResult .= "  <td align=\"center\"><input name=\"chkIDcheck_".$rowDb['id_adm_module']."\" id=\"chkIDcheck_".$rowDb['id_adm_module']."\" type=\"checkbox\" value='noSave' onClick=\"checkClick(this);\" [chkIDApproveModule_".$rowDb['id_adm_module']."]></td>";
        $strResult .= "  <td align=\"center\"><input name=\"chkIDapprove_".$rowDb['id_adm_module']."\" id=\"chkIDapprove_".$rowDb['id_adm_module']."\" type=\"checkbox\" value='noSave' onClick=\"checkClick(this);\" [chkIDApproveModule_".$rowDb['id_adm_module']."]></td>";
        $strResult .= "  <td align=\"center\"><input name=\"chkIDapprove2_".$rowDb['id_adm_module']."\" id=\"chkIDapprove2_".$rowDb['id_adm_module']."\" type=\"checkbox\" value='noSave' onClick=\"checkClick(this);\" [chkIDApprove2Module_".$rowDb['id_adm_module']."]></td>";
        $strResult .= "</tr>";
      ...
      if ($rowDb['menu_level'] == 0)
      {
        ...
        $chkIDapprove2 = "chkIDapprove2_".$rowDb['id_adm_module']."_".$rowDb['id_adm_menu'];
        //save last chkID
        ...
        $lastChkIDapprove2 = $chkIDapprove2;
      }
      else
      {
        ...
        $chkIDapprove2 = $lastChkIDapprove2."_".$rowDb['id_adm_menu'];
      }
      ...
      $strRows .= "  <td align=\"center\"><input ".$rowDb['viewchecked']." name=\"".$chkIDview."\" id=\"".$chkIDview."\" type=\"checkbox\" onClick=\"checkClick(this);\"></td>";
      $strRows .= "  <td align=\"center\"><input ".$rowDb['editchecked']." name=\"".$chkIDedit."\" id=\"".$chkIDedit."\" type=\"checkbox\" onClick=\"checkClick(this);\"></td>";
      $strRows .= "  <td align=\"center\"><input ".$rowDb['deletechecked']." name=\"".$chkIDdelete."\" id=\"".$chkIDdelete."\" type=\"checkbox\" onClick=\"checkClick(this);\"></td>";
      $strRows .= "  <td align=\"center\"><input ".$rowDb['checkchecked']." name=\"".$chkIDcheck."\" id=\"".$chkIDcheck."\" type=\"checkbox\" onClick=\"checkClick(this);\"></td>";
      $strRows .= "  <td align=\"center\"><input ".$rowDb['approvechecked']." name=\"".$chkIDapprove."\" id=\"".$chkIDapprove."\" type=\"checkbox\" onClick=\"checkClick(this);\"></td>";
      $strRows .= "  <td align=\"center\"><input ".$rowDb['approve2checked']." name=\"".$chkIDapprove2."\" id=\"".$chkIDapprove2."\" type=\"checkbox\" onClick=\"checkClick(this);\"></td>";
      $strRows .= "</tr>";
    ...
    foreach($arrMenu as $rowDb)
    {
      if($lastModule != $rowDb['id_adm_module'])
      {
        if ($lastModule != '/undefined/')
        {
          ...
          $strResult = str_replace("[chkIDApprove2Module_".$lastModule."]", $result['approve2checked'], $strResult);
          $result['viewchecked'] = '';
          $result['editchecked'] = '';
          $result['deletechecked'] = '';
          $result['checkchecked'] = '';
      ...
      if ($rowDb['view'] == 't') $result['viewchecked'] = 'checked';
      if ($rowDb['edit'] == 't') $result['editchecked'] = 'checked';
      if ($rowDb['delete'] == 't') $result['deletechecked'] = 'checked';
      if ($rowDb['check'] == 't') $result['checkchecked'] = 'checked';
      if ($rowDb['approve'] == 't') $result['approvechecked'] = 'checked';
      if ($rowDb['approve2'] == 't') $result['approve2checked'] = 'checked';
    }
    if ($lastModule != '/undefined/')
    {
      $strResult = str_replace("[chkIDViewModule_".$lastModule."]", $result['viewchecked'], $strResult);
      ...
      $strResult = str_replace("[chkIDCheckModule_".$lastModule."]", $result['checkchecked'], $strResult);
      $strResult = str_replace("[chkIDApproveModule_".$lastModule."]", $result['approvechecked'], $strResult);
      $strResult = str_replace("[chkIDApprove2Module_".$lastModule."]", $result['approvechecked'], $strResult);
    }
  ...
  function refreshPrivileges(&$arrMenu, $maxMenuLevel)
  {
    for($i=$maxMenuLevel; $i>=0; $i--)
    {
      ...
      foreach ($arrMenu as $rowDb)
      {
        if ($rowDb['menu_level'] == $i)
        {
          ...
          if ($rowDb['view'] == 't') $result['view'] = 't';
          if ($rowDb['edit'] == 't') $result['edit'] = 't';
          if ($rowDb['delete'] == 't') $result['delete'] = 't';
          if ($rowDb['check'] == 't') $result['check'] = 't';
          if ($rowDb['approve'] == 't') $result['approve'] = 't';
          if ($rowDb['approve2'] == 't') $result['approve2'] = 't';
        }
      }
      if ($lastParent != "/undefined/" && $lastParent != "")
      {
        ...
        $arrMenu[$lastParent]['check'] = $result['check'];
        $arrMenu[$lastParent]['approve'] = $result['approve'];
        $arrMenu[$lastParent]['approve2'] = $result['approve2'];
      }
    }
    //print_r($arrMenu);
    foreach($arrMenu as &$rowDb)
    {
      ...
      $rowDb['approve2checked'] = ($rowDb['approve2'] == 't') ? "checked" : "";
    }
  }
  ...
  function saveData($strDataID)
  {
    ...
    {
      if (substr($strIndex2,0,9) == 'chkIDview' || substr($strIndex2,0,9) == 'chkIDedit' || substr($strIndex2,0,11) == 'chkIDdelete')
      {
        if ($strValue2 != 'noSave')
        {
          ...
          (isset($_REQUEST['chkIDapprove2_'.$idx])) ? $approveValue2 = 't' : $approveValue2 = 'f';
          $isUpdate = false;
          $arrID = explode("_", $idx);
          if (count($arrID)>0)
          {
            ...
            //insert
            $strSQL .= "INSERT INTO adm_group_menu (id_adm_group, id_adm_menu, \"view\", \"edit\", \"delete\", \"check\", \"approve\", approve2) ";
            $strSQL .= "VALUES('$strDataID', '$idx2', '$viewValue', '$editValue', '$deleteValue', '$checkValue', '$approveValue', '$approveValue2');";
