<?php
  ...
  */
  ...
  function getUserEmployeeInfo() {
    ...
    $strSQL .= "t1.division_code, t1.department_code, t1.section_code, t1.sub_section_code, t1.id_company, t1.branch_code,t1.management_code ";
...
function totalWorkDayEmployee($db, $strIDEmployee, $strFrom, $strThru) 
  ...
  function scopeData(&$strDataEmployee, &$strDataSubSection, &$strDataSection, &$strDataDepartment, &$strDataDivision, $strDataUserRole, $arrUserInfo, &$strDataBranch)
  {
    $bolScoped = true;
