<?php
  ...
  function getFormDocumentNumber($dtTransDate, $tblName, $docDateName, $columnNumberName, $formatterFunction, $forceResetType = null)
  {
    global $resetType;

    if ($forceResetType == null) $forceResetType = $resetType;
    ...
    $arrResult = array($strResult1, $strResult2);
    return $arrResult;
  }
  ...
  function formattingDocumentMRF($year, $month, $no)
  {
    if (isset($_SESSION['sessionCompanyData']['code']))
      return "MRF/".$_SESSION['sessionCompanyData']['code']."/$year/".formatLeadingZero($month,2)."/".formatLeadingZero($no, 3);
    else
