...
if (!isset($_POST['x_type'])) { 
  ...
  if ((trim($x_type)=='-')   and ($msg_text=='')) $msg_text = 'Please enter your gender.' ; 
  if ((trim($x_name)=='')    and ($msg_text=='')) $msg_text = 'Please enter your last name.' ; 
  if ((trim($x_subname)=='') and ($msg_text=='')) $msg_text = 'Please enter your first name.' ; 
  if ($msg_text=='') {
    $msg_text = 'Thank you.' ; 
