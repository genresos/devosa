...
if ($dt2->isLeapYear()) echo "Tahun ".$dt2->format("Y")." adalah tahun kabisat". "<br />";
else echo "Tahun ".$dt2->format("Y")." bukan merupakan tahun kabisat". "<br />";
echo "Hasil \$dt3 (with time format) : ".$dt3->format("Y-m-d H:i:s"). "<br />";
if ($dt1->equals($dt3)) echo "\$dt1 sama dengan \$dt3". "<br />";
else echo "\$dt1 tidak sama dengan \$dt3". "<br />";
