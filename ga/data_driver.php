<?php
  ...
  */
  ...
  if ($bolCanEdit)
  {
    ...
    $f->addInput(getWords("Driver Name"), "dataDriverName", "", array("size" => 45), "string", true, true, true); 
    $f->addInput(getWords("Addres"), "dataAddress", "", array("size" => 45), "string", true, true, true); 
	$f->addInput(getWords("Phone Number"), "dataPhoneNumber", "", array("size" => 45), "string", true, true, true);
  ...
  //-------------------------------------- BEGIN Data Grid---------------------------------------------------------------------------------//
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Driver Name"), "driver_name", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Address"), "address", array('width' => '40'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("phone"), "phone_number", array('width' => '160'),array('nowrap' => '')));
  ...
  function saveData() 
  {
    ...
    $data = array("driver_name" => $f->getValue('dataDriverName'),
