<?php
   ...
   function getData($db)
  {
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Req.No"), "vehicle_req_no", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Item"), "item_name", array('width' => '100'),array('nowrap' => '')));   
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Driver"), "driver_name", array('width' => '100'),array('nowrap' => ''))); 
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Date To"), "date_to", array('width' => '150'),array('nowrap' => '')));
  ...
  if ($db->connect()) 
  {
    ...
    $f->addSelect(getWords("Vehicle request"), "dataIdVehicleRequest",getDataLisVehicleRequest($arrData['dataIdVehicleRequest'], true, array("value" => "",
	     "text" => "", "selected" => true)),  array ("size"=>10), "", false, true, true);
    $f->addSelect(getWords("Item"), "dataIdItem",getDataListItemCriteria($db,$arrData['dataIdItem'], false, array("value" => "",
	     "text" => "", "selected" => true),"Vehicle"),  array ("style" => "width:200","size" =>10), "", false, true, true);
    $f->addSelect(getWords("Driver"), "dataIdDriver",getDataListDriver($arrData['dataIdRoom'], false, array("value" => "",
	     "text" => "", "selected" => true)),  array ("style" => "width:200"), "", false, true, true);
    $f->addInput(getWords("Request date From"), "dataRequestDateFrom","", array("style" => "width:$strDateWidth"), "date", false, true, true);
	$f->addInput(getWords("Request date to"), "dataRequestDateThru","", array("style" => "width:$strDateWidth"), "date", false, true, true);
	$f->addInput("(Date From) From", "dataDateFromFrom","", array("style" => "width:$strDateWidth"), "date", false, true, true);
	$f->addInput("(Date From) Thru", "dataDateFromThru","", array("style" => "width:$strDateWidth"), "date", false, true, true);
	$f->addInput("(Date To) From", "dataDateToFrom","", array("style" => "width:$strDateWidth"), "date", false, true, true);
	$f->addInput("(Date To) Thru", "dataDateToThru","", array("style" => "width:$strDateWidth"), "date", false, true, true);
