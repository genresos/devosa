  ...
  if ($db->connect())
  {
   ...
   // --------------------------------------------------------------------------------------------------------------------------------
    ...
    if ($bolCanEdit)
    {
      ...
      $f->addSelect(getWords("Category Item"), "dataIdCategory",getDataListCategoryItem($arrData['dataIdCategory'], true, array("value" => "",
      ...
      $f->addInput(getWords("item unit"), "dataItemUnit", 	$arrData['dataItemUnit'], array("size" => 50), "string", true, true, true);
      $f->addInput(getWords("item price"), "dataItemPrice",	$arrData['dataItemPrice'], array("size" => 50), "string", true, true, true);
      $f->addInput(getWords("Entry date"), "dataItemEntryDate",$arrData['dataItemEntryDate'], array("style" => "width:$strDateWidth"), "date", false, true, true);
      $f->addInput(getWords("due date"), "dataItemDueDate", $arrData['dataItemDueDate'], array("style" => "width:$strDateWidth"), "date", false, true, true);
      $f->addInput(getWords("stock"), "dataItemStock", 		$arrData['dataItemStock'], array("size" => 10), "string", true, true, true);
      ...
      $f->addSelect(getWords("Locatoin Room"), "dataIdRoom",getDataListRoom($arrData['dataIdRoom'], true, array("value" => "",
	   ...
	   if ($strReadonly==""){
		  $f->addSelect(getWords("departement"), "dataDepartment",getDataListDepartment($arrData['dataDepartment'], true, array("value" => "",
	      "text" => "", "selected" => true)),  array ("style" => "width:200"), "", false, true, true);
		}else{
