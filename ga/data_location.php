<?php
  ...
  */
  ...
  if ($bolCanEdit)
  {
    ...
    $f->addInput(getWords("Location Name"), "location_name", "", array("size" => 30, "maxlength" => 31), "string", true, true, true);  
    $f->addTextArea(getWords("Remarks"), "remark", "", array("cols" => 60, "rows" => 4, "maxlength" => 255), "string", false, true, true); 
  ...
  //-------------------------------------- BEGIN Data Grid---------------------------------------------------------------------------------//
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Location Name"), "location_name", array('width' => '150'),array('nowrap' => '')));
  ...
  function saveData() 
  {
    ...
    $data = array("location_name" => $f->getValue('location_name'),
