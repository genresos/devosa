<?php
  ...
  echo $dataIdItem;
    if ($bolCanEdit)
    {
      ...
      $f->addInput(getWords("Delivery order number#"), "dataDONumber",	$arrData['dataDONumber'], array("size" => 50), "string", true, true, true);
      if ($isNew){
	  $f->addSelect(getWords("Request Order ID"), "dataIdRequestOrder",getDataRequestOrder($arrData['dataIdRequestOrder'], true, array("value" => "",
	     "text" => "", "selected" => true),"AND active='YES'"),  array ("style" => "width:200"), "", false, true, true);
	  $f->addSelect(getWords("Purchase Request ID"), "dataIdPurchaseRequest",getDataListPurchaseNo($arrData['dataIdPurchaseRequest'], true, array("value" => "",
	     "text" => "", "selected" => true),"AND active_do='YES'"),  array ("style" => "width:200"), "", false, true, true);
	  }else{
	  $f->addSelect(getWords("Request Order ID"), "dataIdRequestOrder",getDataRequestOrder($arrData['dataIdRequestOrder'], true, array("value" => "",
	     "text" => "", "selected" => true)),  array ("style" => "width:200"), "", false, false, true);
	   $f->addSelect(getWords("Purchase Request ID"), "dataIdPurchaseRequest",getDataListPurchaseNo($arrData['dataIdPurchaseRequest'], true, array("value" => "",
	     "text" => "", "selected" => true)),  array ("style" => "width:200"), "", false, false, true);
	  }
      $f->addSelect(getWords("Asset Category Item"), "dataIdCategory",getDataListCategoryItem($arrData['dataIdCategory'], true, array("value" => "",
      ...
      $f->addInput(getWords("Item Code"), "dataItemCode",	$arrData['dataItemCode'], array("size" => 50), "string", true, true, true);
      $f->addInput(getWords("item name"), "dataItemName", 	$arrData['dataItemName'], array("size" => 50), "string", true, true, true);
      $f->addInput(getWords("item price"), "dataItemPrice",	$arrData['dataItemPrice'], array("size" => 50), "numeric", true, true, true);
      $f->addInput(getWords("delivery date"), "dataDeliveryDate",$arrData['dataDeliveryDate'], array("style" => "width:$strDateWidth"), "date", false, true, true);
      $f->addInput(getWords("due date"), "dataDueDate", $arrData['dataDueDate'], array("style" => "width:$strDateWidth"), "date", false, true, true);
	  $f->addInput(getWords("serial number"), "dataSerialNumber" ,$arrData['dataSerialNumber'], array("size" => 50), "string", false, true, true);
	  $f->addSelect(getWords("vendor"), "dataVendor",getDataVendor($arrData['dataVendor'], true, array("value" => "",
	     "text" => "", "selected" => true)),  array ("style" => "width:200"), "", false, true, true);
