  ...
  if ($db->connect())
  {
   ...
   // --------------------------------------------------------------------------------------------------------------------------------
    ...
    if ($bolCanEdit)
    {
      ...
      $f->addInput(getWords("Request No"), "dataConsReqNo", $arrData['dataConsReqNo'], array("size" => 40,), "string", true, true, true);
	  $f->addSelect(getWords("Item"), "dataIdItem",getDataListItemCriteria($db,$arrData['dataIdItem'], true, array("value" => "",
	     "text" => "", "selected" => true),"Consumable"),  array ("style" => "width:200","size" =>10), "", true, true, true);
      ...
      $f->addLabelAutoComplete("","dataEmployee","");
	   ...
	   //--------------------------------------------------------------------------------------------------------------------------------------
	  $f->addInput(getWords("Amount"), "dataAmount", $arrData['dataAmount'], array("size" => 20,), "numeric", true, true, true);
