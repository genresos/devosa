<?php
  ...
  */
   ...
   function getData($db)
  {
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Category"), "category_name", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Code"), "item_code", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Name"), "item_name", array('width' => '150'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("unit"), "item_unit", array('width' => '50'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("price"), "item_price", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Entry Date"), "item_entry_date", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Due Date"), "item_due_date", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("stock"), "item_stock", array('width' => '40'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column("SN", "serial_number", array('width' => '170'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Employee "), "employee_name", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Rooms"), "room_name", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Code Department"), "department_code", array('width' => '100'),array('nowrap' => '')));
	...
	if (!isset($_POST['btnExportXLS']) && $bolCanEdit)
     ...
     if ($bolCanEdit)
     $myDataGrid->addSpecialButton("btnAssigment","btnAssigment","submit","Assignment",
	    "onClick=\"javascript:return confirm('Do you want Assignmet this item?');\"","AssignmentButton()");
	 $myDataGrid->addSpecialButton("btnDisposal","btnDisposal","submit","Disposal",
	    "onClick=\"javascript:return confirm('Do you want Disposal this item?');\"","DisposalButton()");
	 $myDataGrid->addSpecialButton("btnMaintenance","btnMaintenance","submit","Maintenance",
	    "onClick=\"javascript:return confirm('Do you want Maintenance this item?');\"","MaintenanceButton()");
  ...
  if ($db->connect()) 
  {
    ...
    $f->addSelect(getWords("Category Item"), "dataIdCategory", getDataListCategoryItem(""),
	    array("style" => "width:$strDefaultWidthPx"), "", false); 
	$f->addInput(getWords("Item Code"), "dataItemCode", "", array("size" => 50), "string", false, true, true);
    $f->addInput(getWords("item name"), "dataItemName", "", array("size" => 50), "string", false, true, true);
    $f->addInput(getWords("item price"), "dataItemPrice", "", array("size" => 50), "string", false, true, true);
    $f->addInput(getWords("Entry date From"), "dataEntryDateFrom","", 
	    array("style" => "width:$strDateWidth"), "date", false, true, true);
    $f->addInput(getWords("ENTRY date Thru"), "dataEntryDateThru","", array("style" => "width:$strDateWidth"), "date", false, true, true);
	$f->addInput(getWords("serial number"), "dataSerialNumber", "", array("size" => 50), "string", false, true, true);
    ...
    $f->addSelect(getWords("Lacation Room"), "dataIdRoom", getDataListRoom(""),array("style" => "width:$strDefaultWidthPx"), "", false);
