<?php
  ...
  function getData($db)
  {
   ...
   //-------------------------------------- BEGIN Data Grid---------------------------------------------------------------------------------//
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("department code"), "department_code", array('width' => '100'),array('nowrap' => '')));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("transaction Date"), "transaction_date", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("item amount"), "item_amount", array('width' => '50'),array('nowrap' => '')));
  ...
  if ($db->connect()) 
  {
    ...
    $f->addSelect(getWords("item"), "dataIdItem", getDataListItem(""),array("style" => "width:$strDefaultWidthPx"),"",false);
    $f->addSelect(getWords("department code"), "dataDepartmentCode", getDataListDepartment(""),array("style" => "width:$strDefaultWidthPx"),"",false);
