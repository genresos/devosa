 ...
 // Variabel get ID item yang akan di asigmnent
  ...
  // --------------------------------------------------------------------------------------------------------------------------------
    ...
    if ($bolCanEdit)
    {
      ...
      $f->addInput(getWords("purchase request number"), "dataPurchaseNo", $arrData['dataPurchaseNo'] ,"style='width:250px' ", "string", true, true, true);
	  ...
	  $f->addSelect(getWords("item category"), "dataIdCategory", getDataListCategoryItem($arrData['dataIdCategory'], true, array("value" => "",
	     "text" => "", "selected" => true)),  "style='width:250px' ", "", false, true, true);
      ...
      $f->addTextArea(getWords("remark"), "dataRemark", $arrData['dataRemark'], array("cols" => 40, "rows" => 4, "maxlength" => 255), "string", true, true, true);      $f->addFile(getWords("attachment file"), "dataAttachmentFile" ,$arrData['dataAttachmentFile'],array("size" => 30), "string",true, true, true,"","",true,null, $targetFile);  
...
//--------------------------------------------------------------------------------
  ...
  function saveData() 
  {
    ...
    if ($db->connect())
    {
      ...
      $data = array("id_asset_category" => $f->getValue('dataIdCategory'),
