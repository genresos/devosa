<?php
  ...
  function getData($db)
  {
   ...
   //-------------------------------------- BEGIN Data Grid---------------------------------------------------------------------------------//
	...
	$myDataGrid->addColumn(new DataGrid_Column(getWords("Consumable Purchase No"), "consumable_purchase_no", array('width' => '100'),array('nowrap' => '')));
	$myDataGrid->addColumn(new DataGrid_Column(getWords("Consumable Request No"), "consumable_request_no", array('width' => '100'),array('nowrap' => '')));
  ...
  if ($db->connect()) 
  {
   ...
   $f->addSelect(getWords("item name"), "dataIdItem", getDataListItemCriteria($db,$arrData['dataIdItem'], true, array("value" => "",
	     "text" => "", "selected" => true),"Consumable"),  "style='width:250px' ", "", false, true, true);
    ...
    $f->addInput(getWords("item amount"), "dataItemAmount", $arrData['dataItemAmount'],array("style" => "width:$strDateWidth"), "numeric", false, true, true);
    $f->addTextArea(getWords("remark"), "dataRemark", $arrData['dataRemark'], array("cols" => 40, "rows" => 4, "maxlength" => 255), "string", false, true, true);
