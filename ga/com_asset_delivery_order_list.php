<?php
   ...
   function getData($db)
  {
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Delivery Order Number"), "delivery_order_no", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Request Order"), "request_order_no", array('width' => '100'),array('nowrap' => '')));
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Purchase Request"), "purchase_no", array('width' => '100'),array('nowrap' => '')));
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("Delivery Date"), "delivery_date", array('width' => '100'),array('nowrap' => '')));
   ...
   {
    extract($params);
    return "<a href=\"com_asset_delivery_order_edit.php?dataIDItem=".$record['id_item']."&dataID=".$record['id']."\">" .getWords('edit'). "</a>";
   }
  ...
  if ($db->connect()) 
  {
    ...
    $f->addInput(getWords("Delivery order number#"), "dataDONumber", "", array("size" => 50), "string", false, true, true);
	$f->addSelect(getWords("Request Order ID"), "dataIdRequestOrder", getDataRequestOrder(""),
	    array("style" => "width:$strDefaultWidthPx"), "", false); 
	$f->addSelect(getWords("Purchase Request ID"), "dataIdPurchaseRequest", getDataListPurchaseNo(""),
	    array("style" => "width:$strDefaultWidthPx"), "", false); 
	$f->addSelect(getWords("Asset Category Item"), "dataIdCategory", getDataListCategoryItem(""),
	    array("style" => "width:$strDefaultWidthPx"), "", false);
	$f->addSelect(getWords("vendor"), "dataVendor", getDataVendor(""),
	    array("style" => "width:$strDefaultWidthPx"), "", false);
    ...
    $f->addInput(getWords("item price"), "dataItemPrice", "", array("size" => 50), "numeric", false, true, true);
    $f->addInput(getWords("delivery date"), "dataDeliveryDate","", 
	    array("style" => "width:$strDateWidth"), "date", false, true, true);
    $f->addInput(getWords("due date"), "dataDueDate","", array("style" => "width:$strDateWidth"), "date", false, true, true);
