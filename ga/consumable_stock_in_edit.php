  ...
  // --------------------------------------------------------------------------------------------------------------------------------
    ...
    if ($bolCanEdit)
    {
      ...
      $f->addSelect(getWords("Item"), "dataIdItem", getDataListItem($arrData['dataIdItem'], true, array("value" => "",
	     "text" => "", "selected" => true)),  "style='width:250px' ", "", true, true, true);
      ...
      $f->addInput(getWords("item amount"), "dataItemAmount", $arrData['dataItemAmount'],array("style" => "width:200px"), "numeric", true, true, true);
      $f->addInput(getWords("document no"), "dataDocNo", $arrData['dataDocNo'],array("style" => "width:200px"), "string", false, true, true);
