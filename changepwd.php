<?php
  ...
  $f->addPassword(getWords("old password"), "dataOldPassword", "", "Please enter your old password", false, true, false, true, false, "string", "","", "", "", "" , 50, 20);
  $f->addPassword(getWords("new password"), "dataNewPassword1", "", "Please enter new password", false, true, false, true, false, "string", "","", "", "", "" , 50, 20);
  $f->addPassword(getWords("re-enter password"), "dataNewPassword2", "", "Please re-enter new password", false, true, false, true, false, "string", "","", "", "", "" , 50, 20);
...
//--------------------------------------------------------------------------------
  ...
  function goBack()
  {
    ...
    if ($strRedirect == "") $strRedirect = "main.php";
